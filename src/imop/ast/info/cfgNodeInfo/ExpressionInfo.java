...
public class ExpressionInfo extends NodeInfo {
	...
	/**
	 * For the owner Expression node, this method returns a set of those cells that
	 * are accessed, but for which we do not know whether the access is a read or a
	 * write. (This situation may occur when the owner node is not yet connected to
	 * a leaf CFG node.)
	 * 
	 * @return
	 */
