...
public class NodeInfo implements Cloneable {
	...
	public static HashMap<NodeInfo, CellSet> accessesMap = new HashMap<>();
	private Node node;
	...
	public CellList getReads() {
		if (Misc.isCFGLeafNode(this.getNode())) {
			...
			// System.out.println(this.getIdNumber() + " for " + this.getNode());
