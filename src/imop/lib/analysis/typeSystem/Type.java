...
public abstract class Type {
	...
	public Declaration getExactDeclarationWithoutInitStructure(String tempName) {
		Declaration decl = FrontEnd.parseAlone(this.preString() + " " + tempName + " " + this.postString() + ";",Declaration.class);
		return decl;
	}
	/**
	 * Returns a declaration for <code>tempName</code> with this type,
	...
	public final String internalToString(String idName) {
		if(this instanceof StructType || this instanceof UnionType || this instanceof EnumType) {
			return this.preStringForCopy() + " " + idName + " " + this.postString();
		}
	...
	public static Type getType(Scopeable pointOfInsertion, Expression exp) {
		ExpressionTypeGetter typeGetter = new ExpressionTypeGetter(pointOfInsertion);
