...
public class ParallelConstructCFGInfo extends CFGInfo {
	...
	public List<SideEffect> mySetBody(Statement stmt) {
		...
		// TODO: NO. DON'T DO ANYTHING ANYMORE. THIS IS ALL A JOKE. LOL.
		// In humanely decent words: We do not call expression simplifier here.
//		stmt = Normalization.normalizeLeafNodes(stmt, sideEffectList, Misc.getEnclosingBlock(this.getOwner()));
