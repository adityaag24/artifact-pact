...
//	private int transformCounter = AutomatedUpdater.transformCounter - 1;
	...
	public Set<Node> getIntraTaskCFGLeafContents() {
		...
		for (Node n : this.getLexicalCFGContents()) {
			if (!Misc.isCFGLeafNode(n)) {
				...
				returnSet.add(n);
//				System.out.println(n + " of type " + n.getClass());
...
//		if(transformCounter == AutomatedUpdater.transformCounter) {
//			return returnSet;
//		}
		Set<NodeWithStack> returnSet = new HashSet<>();
		if (Misc.isCFGLeafNode(this.owner)) {
