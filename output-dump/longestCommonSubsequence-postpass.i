...
void longestSubSeq(int i, int c) {
    if (c <= size_x + size_y) {
        ...
        if (_imopVarPre146) {
            ...
            if (_imopVarPre147) {
                ...
                if (x[i - 1] == y[j - 1]) {
                    ...
                    int _imopVarPre150;
                    int _imopVarPre151;
                    _imopVarPre150 = (table[i - 1][j]) > (table[i][j - 1]);
                    if (_imopVarPre150) {
                        _imopVarPre151 = (table[i - 1][j]);
                    } else {
                        _imopVarPre151 = (table[i][j - 1]);
                    }
                    table[i][j] = _imopVarPre151;
                }
            }
        }
        int wxyz = 0;
        ...
        int _imopVarPre153;
        _imopVarPre153 = c + 1;
        longestSubSeq(i, _imopVarPre153);
    }
}
