...
ptsTo(heapCell#9) := [p.f];
ptsTo(heapCell#12) := [heapCell#6];
ptsTo(heapCell#13) := [heapCell#0];
]*/
/*OUT: [ptsTo(stdin) := [nullCell];
ptsTo(stdout) := [nullCell];
ptsTo(stderr) := [nullCell];
...
void init() {
    ...
    for (i = 0; i < 1024; i++) {
        ...
        ptsTo(B) := [heapCell#13];
        ptsTo(_imopVarPre203) := [heapCell#6];
        ptsTo(_imopVarPre206) := [heapCell#0];
        ptsTo(heapCell#12) := [heapCell#6];
        ptsTo(heapCell#13) := [heapCell#0];
        ]*/
        /*OUT: [ptsTo(stdin) := [nullCell];
...
int main(int argc, char **argv) {
    ...
    ptsTo(A) := [nullCell];
    ptsTo(B) := [nullCell];
    ptsTo(_imopVarPre209) := [heapCell#12];
    ptsTo(argv) := [heapCell#14];
    ]*/
    /*OUT: [ptsTo(stdin) := [nullCell];
    ptsTo(stdout) := [nullCell];
    ...
    ptsTo(B) := [nullCell];
    ptsTo(_imopVarPre209) := [heapCell#12];
    ptsTo(_imopVarPre212) := [heapCell#13];
    ptsTo(argv) := [heapCell#14];
    ]*/
    /*OUT: [ptsTo(stdin) := [nullCell];
    ptsTo(stdout) := [nullCell];
        ...
        for (i = 1; i < 1024 - 1; i++) {
            ...
            while (t < 20) {
                ...
                if (1) {
                    ...
                    ptsTo(_imopVarPre209) := [heapCell#12];
                    ptsTo(_imopVarPre212) := [heapCell#13];
                    ptsTo(_imopVarPre216) := [heapCell#4];
                    ptsTo(argv) := [heapCell#14];
                    ptsTo(heapCell#4) := [p.f];
                    ptsTo(heapCell#9) := [p.f];
                    ptsTo(heapCell#12) := [heapCell#6];
                ...
                }
                {
                    ...
                    if (1) {
                        ...
                        ptsTo(_imopVarPre209) := [heapCell#12];
                        ptsTo(_imopVarPre212) := [heapCell#13];
                        ptsTo(_imopVarPre220) := [heapCell#9];
                        ptsTo(argv) := [heapCell#14];
                        ptsTo(heapCell#4) := [p.f];
                        ptsTo(heapCell#9) := [p.f];
                        ptsTo(heapCell#12) := [heapCell#6];
