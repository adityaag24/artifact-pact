...
int main(int argc, char **argv) {
    ...
    ptsTo(postbox_ivp17) := [nullCell];
    ptsTo(A) := [nullCell];
    ptsTo(_imopVarPre204) := [heapCell#6];
    ptsTo(argv) := [heapCell#14];
    ]*/
    /*OUT: [ptsTo(stdin) := [nullCell];
    ptsTo(stdout) := [nullCell];
    ...
    for (i = 0; i < 16384; i++) {
        ...
        ptsTo(_imopVarPre204) := [heapCell#6];
        ptsTo(argv) := [heapCell#14];
        ptsTo(_imopVarPre208) := [heapCell#2];
        ptsTo(heapCell#6) := [heapCell#2];
        ]*/
        /*OUT: [ptsTo(stdin) := [nullCell];
        ptsTo(stdout) := [nullCell];
        ...
        for (i = 1; i < 16384 - 1; i++) {
            ...
            while (t < 50) {
                ...
                if (1) {
                    ...
                    ptsTo(A) := [heapCell#6];
                    ptsTo(_imopVarPre204) := [heapCell#6];
                    ptsTo(_imopVarPre213) := [heapCell#8];
                    ptsTo(argv) := [heapCell#14];
                    ptsTo(heapCell#1) := [p.f];
                    ptsTo(heapCell#5) := [p.f];
                    ptsTo(heapCell#6) := [heapCell#2];
                ...
                }
                {
                    ...
                    if (1) {
                        ...
                        ptsTo(A) := [heapCell#6];
                        ptsTo(_imopVarPre204) := [heapCell#6];
                        ptsTo(_imopVarPre221) := [heapCell#5];
                        ptsTo(argv) := [heapCell#14];
                        ptsTo(heapCell#1) := [p.f];
                        ptsTo(heapCell#5) := [p.f];
                        ptsTo(heapCell#6) := [heapCell#2];
                ...
                }
                {
                    ...
                    if (1) {
                        ...
                        ptsTo(A) := [heapCell#6];
                        ptsTo(_imopVarPre204) := [heapCell#6];
                        ptsTo(_imopVarPre225) := [heapCell#11];
                        ptsTo(argv) := [heapCell#14];
                        ptsTo(heapCell#1) := [p.f];
                        ptsTo(heapCell#5) := [p.f];
                        ptsTo(heapCell#6) := [heapCell#2];
