...
ptsTo(F) := [heapCell#0];
ptsTo(G) := [heapCell#6];
ptsTo(heapCell#0) := [heapCell#7];
ptsTo(heapCell#4) := [heapCell#11];
ptsTo(heapCell#5) := [heapCell#3];
ptsTo(heapCell#6) := [heapCell#1];
ptsTo(heapCell#8) := [heapCell#13];
ptsTo(heapCell#10) := [heapCell#12];
ptsTo(heapCell#14) := [heapCell#9];
]*/
...
void init() {
    ...
    ptsTo(F) := [nullCell];
    ptsTo(G) := [nullCell];
    ptsTo(_imopVarPre113) := [heapCell#4];
    ]*/
    /*OUT: [ptsTo(stdin) := [nullCell];
    ptsTo(stdout) := [nullCell];
    ptsTo(stderr) := [nullCell];
    ...
    ptsTo(G) := [nullCell];
    ptsTo(_imopVarPre113) := [heapCell#4];
    ptsTo(_imopVarPre117) := [heapCell#10];
    ]*/
    /*OUT: [ptsTo(stdin) := [nullCell];
    ptsTo(stdout) := [nullCell];
    ptsTo(stderr) := [nullCell];
    ...
    ptsTo(_imopVarPre113) := [heapCell#4];
    ptsTo(_imopVarPre117) := [heapCell#10];
    ptsTo(_imopVarPre121) := [heapCell#8];
    ]*/
    /*OUT: [ptsTo(stdin) := [nullCell];
    ptsTo(stdout) := [nullCell];
    ptsTo(stderr) := [nullCell];
    ...
    ptsTo(_imopVarPre117) := [heapCell#10];
    ptsTo(_imopVarPre121) := [heapCell#8];
    ptsTo(_imopVarPre125) := [heapCell#14];
    ]*/
    /*OUT: [ptsTo(stdin) := [nullCell];
    ptsTo(stdout) := [nullCell];
    ptsTo(stderr) := [nullCell];
    ...
    ptsTo(_imopVarPre121) := [heapCell#8];
    ptsTo(_imopVarPre125) := [heapCell#14];
    ptsTo(_imopVarPre129) := [heapCell#5];
    ]*/
    /*OUT: [ptsTo(stdin) := [nullCell];
    ptsTo(stdout) := [nullCell];
    ptsTo(stderr) := [nullCell];
    ...
    ptsTo(_imopVarPre125) := [heapCell#14];
    ptsTo(_imopVarPre129) := [heapCell#5];
    ptsTo(_imopVarPre133) := [heapCell#0];
    ]*/
    /*OUT: [ptsTo(stdin) := [nullCell];
    ptsTo(stdout) := [nullCell];
    ptsTo(stderr) := [nullCell];
    ...
    ptsTo(_imopVarPre129) := [heapCell#5];
    ptsTo(_imopVarPre133) := [heapCell#0];
    ptsTo(_imopVarPre137) := [heapCell#6];
    ]*/
    /*OUT: [ptsTo(stdin) := [nullCell];
    ptsTo(stdout) := [nullCell];
    ptsTo(stderr) := [nullCell];
    ...
    for (i = 0; i < 1024; i++) {
        ...
        ptsTo(_imopVarPre133) := [heapCell#0];
        ptsTo(_imopVarPre137) := [heapCell#6];
        ptsTo(_imopVarPre141) := [heapCell#11];
        ptsTo(heapCell#0) := [heapCell#7];
        ptsTo(heapCell#4) := [heapCell#11];
        ptsTo(heapCell#5) := [heapCell#3];
        ptsTo(heapCell#6) := [heapCell#1];
        ...
        ptsTo(_imopVarPre137) := [heapCell#6];
        ptsTo(_imopVarPre141) := [heapCell#11];
        ptsTo(_imopVarPre145) := [heapCell#12];
        ptsTo(heapCell#0) := [heapCell#7];
        ptsTo(heapCell#4) := [heapCell#11];
        ptsTo(heapCell#5) := [heapCell#3];
        ptsTo(heapCell#6) := [heapCell#1];
        ...
        ptsTo(_imopVarPre141) := [heapCell#11];
        ptsTo(_imopVarPre145) := [heapCell#12];
        ptsTo(_imopVarPre149) := [heapCell#13];
        ptsTo(heapCell#0) := [heapCell#7];
        ptsTo(heapCell#4) := [heapCell#11];
        ptsTo(heapCell#5) := [heapCell#3];
        ptsTo(heapCell#6) := [heapCell#1];
        ...
        ptsTo(_imopVarPre145) := [heapCell#12];
        ptsTo(_imopVarPre149) := [heapCell#13];
        ptsTo(_imopVarPre153) := [heapCell#9];
        ptsTo(heapCell#0) := [heapCell#7];
        ptsTo(heapCell#4) := [heapCell#11];
        ptsTo(heapCell#5) := [heapCell#3];
        ptsTo(heapCell#6) := [heapCell#1];
        ...
        ptsTo(_imopVarPre149) := [heapCell#13];
        ptsTo(_imopVarPre153) := [heapCell#9];
        ptsTo(_imopVarPre157) := [heapCell#3];
        ptsTo(heapCell#0) := [heapCell#7];
        ptsTo(heapCell#4) := [heapCell#11];
        ptsTo(heapCell#5) := [heapCell#3];
        ptsTo(heapCell#6) := [heapCell#1];
        ...
        ptsTo(_imopVarPre153) := [heapCell#9];
        ptsTo(_imopVarPre157) := [heapCell#3];
        ptsTo(_imopVarPre161) := [heapCell#7];
        ptsTo(heapCell#0) := [heapCell#7];
        ptsTo(heapCell#4) := [heapCell#11];
        ptsTo(heapCell#5) := [heapCell#3];
        ptsTo(heapCell#6) := [heapCell#1];
        ...
        ptsTo(_imopVarPre157) := [heapCell#3];
        ptsTo(_imopVarPre161) := [heapCell#7];
        ptsTo(_imopVarPre165) := [heapCell#1];
        ptsTo(heapCell#0) := [heapCell#7];
        ptsTo(heapCell#4) := [heapCell#11];
        ptsTo(heapCell#5) := [heapCell#3];
        ptsTo(heapCell#6) := [heapCell#1];
