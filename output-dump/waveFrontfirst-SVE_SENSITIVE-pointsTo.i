...
void init() {
    ...
    ptsTo(rightPointer) := [nullCell];
    ptsTo(A) := [nullCell];
    ptsTo(_imopVarPre112) := [heapCell#1];
    ]*/
    /*OUT: [ptsTo(stdin) := [nullCell];
    ptsTo(stdout) := [nullCell];
    ptsTo(stderr) := [nullCell];
    ...
    for (i = 0; i < 16384; i++) {
        ...
        ptsTo(A) := [heapCell#1];
        ptsTo(_imopVarPre112) := [heapCell#1];
        ptsTo(_imopVarPre115) := [heapCell#0];
        ptsTo(heapCell#1) := [heapCell#0];
        ]*/
        /*OUT: [ptsTo(stdin) := [nullCell];
        ptsTo(stdout) := [nullCell];
