...
ptsTo(A) := [heapCell#4];
ptsTo(B) := [heapCell#3];
ptsTo(heapCell#5) := [p.f];
ptsTo(heapCell#6) := [p.f];
ptsTo(heapCell#8) := [p.f];
ptsTo(heapCell#11) := [p.f];
]*/
/*OUT: [ptsTo(stdin) := [nullCell];
ptsTo(stdout) := [nullCell];
ptsTo(stderr) := [nullCell];
...
ptsTo(A) := [heapCell#4];
ptsTo(B) := [heapCell#3];
ptsTo(p) := [heapCell#11, heapCell#8];
ptsTo(heapCell#5) := [p.f];
ptsTo(heapCell#6) := [p.f];
ptsTo(heapCell#8) := [p.f];
ptsTo(heapCell#11) := [p.f];
...
int main(int argc, char **argv) {
    ...
    ptsTo(B) := [nullCell];
    ptsTo(argv) := [heapCell#14];
    ptsTo(_imopVarPre203) := [heapCell#4];
    ]*/
    /*OUT: [ptsTo(stdin) := [nullCell];
    ptsTo(stdout) := [nullCell];
    ptsTo(stderr) := [nullCell];
    ...
    ptsTo(argv) := [heapCell#14];
    ptsTo(_imopVarPre203) := [heapCell#4];
    ptsTo(_imopVarPre206) := [heapCell#3];
    ]*/
    /*OUT: [ptsTo(stdin) := [nullCell];
    ptsTo(stdout) := [nullCell];
    ptsTo(stderr) := [nullCell];
        ...
        for (i = 1; i < 16384 - 1; i++) {
            ...
            while (t < 50) {
                ...
                if (1) {
                    ...
                    ptsTo(A) := [heapCell#4];
                    ptsTo(B) := [heapCell#3];
                    ptsTo(_imopVarPre210) := [heapCell#8];
                    ptsTo(argv) := [heapCell#14];
                    ptsTo(_imopVarPre203) := [heapCell#4];
                    ptsTo(_imopVarPre206) := [heapCell#3];
                    ptsTo(heapCell#5) := [p.f];
                ...
                }
                {
                    ...
                    if (1) {
                        ...
                        ptsTo(A) := [heapCell#4];
                        ptsTo(B) := [heapCell#3];
                        ptsTo(_imopVarPre214) := [heapCell#5];
                        ptsTo(argv) := [heapCell#14];
                        ptsTo(_imopVarPre203) := [heapCell#4];
                        ptsTo(_imopVarPre206) := [heapCell#3];
                        ptsTo(heapCell#5) := [p.f];
                ...
                A[i] = B[i];
                {
                    ...
                    if (1) {
                        ...
                        ptsTo(A) := [heapCell#4];
                        ptsTo(B) := [heapCell#3];
                        ptsTo(_imopVarPre218) := [heapCell#11];
                        ptsTo(argv) := [heapCell#14];
                        ptsTo(_imopVarPre203) := [heapCell#4];
                        ptsTo(_imopVarPre206) := [heapCell#3];
                        ptsTo(heapCell#5) := [p.f];
                ...
                }
                {
                    ...
                    if (1) {
                        ...
                        ptsTo(A) := [heapCell#4];
                        ptsTo(B) := [heapCell#3];
                        ptsTo(_imopVarPre222) := [heapCell#6];
                        ptsTo(argv) := [heapCell#14];
                        ptsTo(_imopVarPre203) := [heapCell#4];
                        ptsTo(_imopVarPre206) := [heapCell#3];
                        ptsTo(heapCell#5) := [p.f];
