...
int main() {
    ...
    ptsTo(y) := [nullCell];
    ptsTo(z) := [nullCell];
    ptsTo(_imopVarPre112) := [heapCell#0];
    ]*/
    /*OUT: [ptsTo(stdin) := [nullCell];
    ptsTo(stdout) := [nullCell];
    ptsTo(stderr) := [nullCell];
    ...
    for (i = 0; i < 16384; i++) {
        ...
        ptsTo(z) := [nullCell];
        ptsTo(_imopVarPre112) := [heapCell#0];
        ptsTo(_imopVarPre115) := [heapCell#1];
        ptsTo(heapCell#0) := [heapCell#1];
        ]*/
        /*OUT: [ptsTo(stdin) := [nullCell];
        ptsTo(stdout) := [nullCell];
    ...
    ptsTo(z) := [nullCell];
    ptsTo(_imopVarPre112) := [heapCell#0];
    ptsTo(_imopVarPre118) := [heapCell#3];
    ptsTo(heapCell#0) := [heapCell#1];
    ]*/
    /*OUT: [ptsTo(stdin) := [nullCell];
    ptsTo(stdout) := [nullCell];
    ...
    ptsTo(_imopVarPre112) := [heapCell#0];
    ptsTo(_imopVarPre118) := [heapCell#3];
    ptsTo(_imopVarPre121) := [heapCell#4];
    ptsTo(heapCell#0) := [heapCell#1];
    ]*/
    /*OUT: [ptsTo(stdin) := [nullCell];
    ptsTo(stdout) := [nullCell];
    ...
    ptsTo(_imopVarPre118) := [heapCell#3];
    ptsTo(_imopVarPre121) := [heapCell#4];
    ptsTo(_imopVarPre124) := [heapCell#2];
    ptsTo(heapCell#0) := [heapCell#1];
    ]*/
    /*OUT: [ptsTo(stdin) := [nullCell];
    ptsTo(stdout) := [nullCell];
    ...
    ptsTo(_imopVarPre121) := [heapCell#4];
    ptsTo(_imopVarPre124) := [heapCell#2];
    ptsTo(_imopVarPre127) := [heapCell#5];
    ptsTo(heapCell#0) := [heapCell#1];
    ]*/
    /*OUT: [ptsTo(stdin) := [nullCell];
    ptsTo(stdout) := [nullCell];
    ...
    ptsTo(_imopVarPre124) := [heapCell#2];
    ptsTo(_imopVarPre127) := [heapCell#5];
    ptsTo(_imopVarPre130) := [heapCell#10];
    ptsTo(heapCell#0) := [heapCell#1];
    ]*/
    /*OUT: [ptsTo(stdin) := [nullCell];
    ptsTo(stdout) := [nullCell];
    ...
    ptsTo(_imopVarPre127) := [heapCell#5];
    ptsTo(_imopVarPre130) := [heapCell#10];
    ptsTo(_imopVarPre133) := [heapCell#6];
    ptsTo(heapCell#0) := [heapCell#1];
    ]*/
    /*OUT: [ptsTo(stdin) := [nullCell];
    ptsTo(stdout) := [nullCell];
    ...
    ptsTo(_imopVarPre130) := [heapCell#10];
    ptsTo(_imopVarPre133) := [heapCell#6];
    ptsTo(_imopVarPre136) := [heapCell#7];
    ptsTo(heapCell#0) := [heapCell#1];
    ]*/
    /*OUT: [ptsTo(stdin) := [nullCell];
    ptsTo(stdout) := [nullCell];
    ...
    ptsTo(_imopVarPre133) := [heapCell#6];
    ptsTo(_imopVarPre136) := [heapCell#7];
    ptsTo(_imopVarPre139) := [heapCell#9];
    ptsTo(heapCell#0) := [heapCell#1];
    ]*/
    /*OUT: [ptsTo(stdin) := [nullCell];
    ptsTo(stdout) := [nullCell];
