...
ptsTo(weights) := [heapCell#2];
ptsTo(profits) := [heapCell#1];
ptsTo(newProfit) := [heapCell#5, heapCell#0];
ptsTo(oldProfit) := [heapCell#5, heapCell#0];
ptsTo(temp) := [heapCell#3, heapCell#5, heapCell#0];
...
ptsTo(leftPointer) := [nullCell];
ptsTo(rightPointer) := [nullCell];
ptsTo(weights) := [nullCell];
ptsTo(profits) := [nullCell];
ptsTo(newProfit) := [nullCell];
ptsTo(oldProfit) := [nullCell];
ptsTo(temp) := [nullCell];
...
int main(int argc, char **argv) {
    ...
    ptsTo(_imopVarPre122) := [C];
    ptsTo(_imopVarPre123) := [N];
    ptsTo(_imopVarPre125) := [heapCell#2];
    ptsTo(argv) := [heapCell#6];
    ]*/
    /*OUT: [ptsTo(stdin) := [nullCell];
    ptsTo(stdout) := [nullCell];
    ...
    ptsTo(_imopVarPre123) := [N];
    ptsTo(_imopVarPre125) := [heapCell#2];
    ptsTo(_imopVarPre127) := [heapCell#1];
    ptsTo(argv) := [heapCell#6];
    ]*/
    /*OUT: [ptsTo(stdin) := [nullCell];
    ptsTo(stdout) := [nullCell];
    ...
    ptsTo(_imopVarPre125) := [heapCell#2];
    ptsTo(_imopVarPre127) := [heapCell#1];
    ptsTo(_imopVarPre129) := [heapCell#3];
    ptsTo(argv) := [heapCell#6];
    ]*/
    /*OUT: [ptsTo(stdin) := [nullCell];
    ptsTo(stdout) := [nullCell];
    ...
    for (k = 0; k < N; k++) {
        ...
        ptsTo(_imopVarPre129) := [heapCell#3];
        ptsTo(argv) := [heapCell#6];
        ptsTo(_imopVarPre133) := [heapCell#1];
        ptsTo(_imopVarPre134) := [nullCell];
        ]*/
        ...
        ptsTo(argv) := [heapCell#6];
        ptsTo(_imopVarPre133) := [heapCell#1];
        ptsTo(_imopVarPre134) := [heapCell#2];
        ]*/
...
void knapSack(int i, int k) {
    ...
    if (i < N) {
        ...
        ptsTo(newProfit) := [heapCell#5, heapCell#0];
        ptsTo(oldProfit) := [heapCell#5, heapCell#0];
        ptsTo(temp) := [heapCell#5, heapCell#0];
        ptsTo(heapCell#0) := [nullCell];
        ptsTo(heapCell#5) := [nullCell];
        ]*/
        temp = newProfit;
