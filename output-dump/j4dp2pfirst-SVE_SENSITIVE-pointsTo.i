...
ptsTo(A) := [heapCell#5];
ptsTo(B) := [heapCell#7];
ptsTo(heapCell#2) := [p.f];
ptsTo(heapCell#5) := [heapCell#10];
ptsTo(heapCell#7) := [heapCell#13];
...
ptsTo(A) := [heapCell#5];
ptsTo(B) := [heapCell#7];
ptsTo(p) := [heapCell#11, heapCell#2];
ptsTo(heapCell#2) := [p.f];
ptsTo(heapCell#5) := [heapCell#10];
ptsTo(heapCell#7) := [heapCell#13];
ptsTo(heapCell#11) := [p.f];
...
ptsTo(A) := [heapCell#5];
ptsTo(B) := [heapCell#7];
ptsTo(p) := [heapCell#15, heapCell#14];
ptsTo(heapCell#2) := [p.f];
ptsTo(heapCell#5) := [heapCell#10];
ptsTo(heapCell#7) := [heapCell#13];
ptsTo(heapCell#11) := [p.f];
...
void init() {
    ...
    for (i = 0; i < 1024; i++) {
        ...
        ptsTo(A) := [heapCell#5];
        ptsTo(B) := [heapCell#7];
        ptsTo(_imopVarPre203) := [heapCell#10];
        ptsTo(heapCell#5) := [heapCell#10];
        ptsTo(heapCell#7) := [heapCell#13];
        ]*/
        /*OUT: [ptsTo(stdin) := [nullCell];
        ...
        ptsTo(B) := [heapCell#7];
        ptsTo(_imopVarPre203) := [heapCell#10];
        ptsTo(_imopVarPre206) := [heapCell#13];
        ptsTo(heapCell#5) := [heapCell#10];
        ptsTo(heapCell#7) := [heapCell#13];
        ]*/
        /*OUT: [ptsTo(stdin) := [nullCell];
...
int main(int argc, char **argv) {
    ...
    _imopVarPre209 = calloc(1024, _imopVarPre208);
    /*OUT: [ptsTo(stdin) := [nullCell];
    ptsTo(stdout) := [nullCell];
    ptsTo(stderr) := [nullCell];
    ptsTo(globalWorklist) := [nullCell];
    ...
    _imopVarPre212 = calloc(1024, _imopVarPre211);
    /*OUT: [ptsTo(stdin) := [nullCell];
    ptsTo(stdout) := [nullCell];
    ptsTo(stderr) := [nullCell];
    ptsTo(globalWorklist) := [nullCell];
    ...
    ptsTo(B) := [nullCell];
    ptsTo(_imopVarPre209) := [heapCell#5];
    ptsTo(_imopVarPre212) := [heapCell#7];
    ptsTo(argv) := [heapCell#16];
    ]*/
    /*OUT: [ptsTo(stdin) := [nullCell];
    ptsTo(stdout) := [nullCell];
        ...
        for (i = 1; i < 1024 - 1; i++) {
            ...
            while (t < 20) {
                ...
                if (1) {
                    ...
                    ptsTo(_imopVarPre209) := [heapCell#5];
                    ptsTo(_imopVarPre212) := [heapCell#7];
                    ptsTo(_imopVarPre216) := [heapCell#15];
                    ptsTo(argv) := [heapCell#16];
                    ptsTo(heapCell#2) := [p.f];
                    ptsTo(heapCell#5) := [heapCell#10];
                    ptsTo(heapCell#7) := [heapCell#13];
                ...
                }
                {
                    ...
                    if (1) {
                        ...
                        ptsTo(_imopVarPre209) := [heapCell#5];
                        ptsTo(_imopVarPre212) := [heapCell#7];
                        ptsTo(_imopVarPre220) := [heapCell#11];
                        ptsTo(argv) := [heapCell#16];
                        ptsTo(heapCell#2) := [p.f];
                        ptsTo(heapCell#5) := [heapCell#10];
                        ptsTo(heapCell#7) := [heapCell#13];
                ...
                }
                {
                    ...
                    if (1) {
                        ...
                        ptsTo(_imopVarPre209) := [heapCell#5];
                        ptsTo(_imopVarPre212) := [heapCell#7];
                        ptsTo(_imopVarPre228) := [heapCell#2];
                        ptsTo(argv) := [heapCell#16];
                        ptsTo(heapCell#2) := [p.f];
                        ptsTo(heapCell#5) := [heapCell#10];
                        ptsTo(heapCell#7) := [heapCell#13];
