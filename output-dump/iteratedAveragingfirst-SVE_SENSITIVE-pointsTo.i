...
ptsTo(newA) := [heapCell#2, heapCell#3];
ptsTo(oldA) := [heapCell#2, heapCell#3];
ptsTo(diff) := [heapCell#0];
ptsTo(temp) := [heapCell#2, nullCell, heapCell#3];
...
int main() {
    ...
    ptsTo(diff) := [nullCell];
    ptsTo(temp) := [nullCell];
    ptsTo(_imopVarPre116) := [heapCell#2];
    ]*/
    /*OUT: [ptsTo(stdin) := [nullCell];
    ptsTo(stdout) := [nullCell];
    ptsTo(stderr) := [nullCell];
    ...
    ptsTo(temp) := [nullCell];
    ptsTo(_imopVarPre116) := [heapCell#2];
    ptsTo(_imopVarPre122) := [heapCell#3];
    ]*/
    /*OUT: [ptsTo(stdin) := [nullCell];
    ptsTo(stdout) := [nullCell];
    ptsTo(stderr) := [nullCell];
    ...
    ptsTo(_imopVarPre116) := [heapCell#2];
    ptsTo(_imopVarPre122) := [heapCell#3];
    ptsTo(_imopVarPre128) := [heapCell#0];
    ]*/
    /*OUT: [ptsTo(stdin) := [nullCell];
    ptsTo(stdout) := [nullCell];
    ptsTo(stderr) := [nullCell];
        ...
        for (i = 1; i <= 4096; i++) {
            ...
            while (epsilon <= delta) {
                ...
                if (i == 1) {
                    ...
                    ptsTo(oldA) := [heapCell#2, heapCell#3];
                    ptsTo(diff) := [heapCell#0];
                    ptsTo(temp) := [heapCell#2, heapCell#3];
                    ptsTo(_imopVarPre116) := [heapCell#2];
                    ptsTo(_imopVarPre122) := [heapCell#3];
                    ptsTo(_imopVarPre128) := [heapCell#0];
                    ptsTo(heapCell#2) := [nullCell];
