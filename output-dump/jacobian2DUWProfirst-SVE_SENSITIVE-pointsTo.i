...
ptsTo(A) := [heapCell#5];
ptsTo(B) := [heapCell#11];
ptsTo(heapCell#0) := [p.f];
ptsTo(heapCell#5) := [heapCell#14];
ptsTo(heapCell#6) := [p.f];
ptsTo(heapCell#10) := [p.f];
ptsTo(heapCell#11) := [heapCell#2];
...
ptsTo(A) := [heapCell#5];
ptsTo(B) := [heapCell#11];
ptsTo(p) := [heapCell#6, heapCell#15];
ptsTo(heapCell#0) := [p.f];
ptsTo(heapCell#5) := [heapCell#14];
ptsTo(heapCell#6) := [p.f];
ptsTo(heapCell#10) := [p.f];
...
ptsTo(A) := [heapCell#5];
ptsTo(B) := [heapCell#11];
ptsTo(p) := [heapCell#10, heapCell#0];
ptsTo(heapCell#0) := [p.f];
ptsTo(heapCell#5) := [heapCell#14];
ptsTo(heapCell#6) := [p.f];
ptsTo(heapCell#10) := [p.f];
...
void init() {
    ...
    for (i = 0; i < 16384; i++) {
        ...
        ptsTo(A) := [heapCell#5];
        ptsTo(B) := [heapCell#11];
        ptsTo(_imopVarPre203) := [heapCell#14];
        ptsTo(heapCell#5) := [heapCell#14];
        ptsTo(heapCell#11) := [heapCell#2];
        ]*/
        /*OUT: [ptsTo(stdin) := [nullCell];
        ...
        ptsTo(B) := [heapCell#11];
        ptsTo(_imopVarPre203) := [heapCell#14];
        ptsTo(_imopVarPre206) := [heapCell#2];
        ptsTo(heapCell#5) := [heapCell#14];
        ptsTo(heapCell#11) := [heapCell#2];
        ]*/
        /*OUT: [ptsTo(stdin) := [nullCell];
...
int main(int argc, char **argv) {
    ...
    ptsTo(A) := [nullCell];
    ptsTo(B) := [nullCell];
    ptsTo(_imopVarPre209) := [heapCell#5];
    ptsTo(argv) := [heapCell#16];
    ]*/
    /*OUT: [ptsTo(stdin) := [nullCell];
    ptsTo(stdout) := [nullCell];
    ...
    ptsTo(B) := [nullCell];
    ptsTo(_imopVarPre209) := [heapCell#5];
    ptsTo(_imopVarPre212) := [heapCell#11];
    ptsTo(argv) := [heapCell#16];
    ]*/
    /*OUT: [ptsTo(stdin) := [nullCell];
    ptsTo(stdout) := [nullCell];
        ...
        for (i = 1; i < 16384 - 1; i++) {
            ...
            while (t < 50) {
                ...
                if (1) {
                    ...
                    ptsTo(_imopVarPre209) := [heapCell#5];
                    ptsTo(_imopVarPre212) := [heapCell#11];
                    ptsTo(_imopVarPre216) := [heapCell#10];
                    ptsTo(argv) := [heapCell#16];
                    ptsTo(heapCell#0) := [p.f];
                    ptsTo(heapCell#5) := [heapCell#14];
                    ptsTo(heapCell#6) := [p.f];
                ...
                }
                {
                    ...
                    if (1) {
                        ...
                        ptsTo(_imopVarPre209) := [heapCell#5];
                        ptsTo(_imopVarPre212) := [heapCell#11];
                        ptsTo(_imopVarPre224) := [heapCell#0];
                        ptsTo(argv) := [heapCell#16];
                        ptsTo(heapCell#0) := [p.f];
                        ptsTo(heapCell#5) := [heapCell#14];
                        ptsTo(heapCell#6) := [p.f];
                ...
                }
                {
                    ...
                    if (1) {
                        ...
                        ptsTo(_imopVarPre209) := [heapCell#5];
                        ptsTo(_imopVarPre212) := [heapCell#11];
                        ptsTo(_imopVarPre228) := [heapCell#6];
                        ptsTo(argv) := [heapCell#16];
                        ptsTo(heapCell#0) := [p.f];
                        ptsTo(heapCell#5) := [heapCell#14];
                        ptsTo(heapCell#6) := [p.f];
