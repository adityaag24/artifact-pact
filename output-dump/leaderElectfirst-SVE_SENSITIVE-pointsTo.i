...
ptsTo(IdStore) := [heapCell#1];
ptsTo(processSet) := [heapCell#0];
ptsTo(heapCell#0) := [nullCell];
]*/
...
ptsTo(leftPointer) := [nullCell];
ptsTo(rightPointer) := [nullCell];
ptsTo(IdStore) := [nullCell];
ptsTo(processSet) := [nullCell];
ptsTo(argv) := [heapCell#3];
]*/
/*OUT: [ptsTo(stdin) := [nullCell];
ptsTo(stdout) := [nullCell];
ptsTo(stderr) := [nullCell];
...
int main(int argc, char *argv[]) {
    ...
    ptsTo(_imopVarPre112) := [nullCell];
    ptsTo(input) := [nullCell];
    ptsTo(_imopVarPre114) := [processes];
    ]*/
    ...
    ptsTo(input) := [nullCell];
    ptsTo(_imopVarPre114) := [processes];
    ptsTo(_imopVarPre117) := [heapCell#1];
    ]*/
    /*OUT: [ptsTo(stdin) := [nullCell];
    ptsTo(stdout) := [nullCell];
    ptsTo(stderr) := [nullCell];
    ...
    for (i = 0; i < processes; i++) {
        ...
        ptsTo(_imopVarPre114) := [processes];
        ptsTo(_imopVarPre117) := [heapCell#1];
        ptsTo(_imopVarPre119) := [heapCell#1];
        ]*/
    ...
    ptsTo(_imopVarPre114) := [processes];
    ptsTo(_imopVarPre117) := [heapCell#1];
    ptsTo(_imopVarPre122) := [heapCell#0];
    ]*/
    /*OUT: [ptsTo(stdin) := [nullCell];
    ptsTo(stdout) := [nullCell];
    ptsTo(stderr) := [nullCell];
