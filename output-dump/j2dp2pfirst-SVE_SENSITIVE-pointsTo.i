...
ptsTo(A) := [heapCell#0];
ptsTo(B) := [heapCell#15];
ptsTo(p) := [heapCell#10, heapCell#4];
ptsTo(heapCell#0) := [heapCell#11];
ptsTo(heapCell#1) := [p.f];
ptsTo(heapCell#4) := [p.f];
ptsTo(heapCell#7) := [p.f];
...
void init() {
    ...
    for (i = 0; i < 1024; i++) {
        ...
        ptsTo(A) := [heapCell#0];
        ptsTo(B) := [heapCell#15];
        ptsTo(_imopVarPre203) := [heapCell#11];
        ptsTo(heapCell#0) := [heapCell#11];
        ptsTo(heapCell#15) := [heapCell#8];
        ]*/
        /*OUT: [ptsTo(stdin) := [nullCell];
...
int main(int argc, char **argv) {
    ...
    ptsTo(A) := [nullCell];
    ptsTo(B) := [nullCell];
    ptsTo(_imopVarPre209) := [heapCell#0];
    ptsTo(argv) := [heapCell#16];
    ]*/
    /*OUT: [ptsTo(stdin) := [nullCell];
    ptsTo(stdout) := [nullCell];
    ...
    ptsTo(B) := [nullCell];
    ptsTo(_imopVarPre209) := [heapCell#0];
    ptsTo(_imopVarPre212) := [heapCell#15];
    ptsTo(argv) := [heapCell#16];
    ]*/
    /*OUT: [ptsTo(stdin) := [nullCell];
    ptsTo(stdout) := [nullCell];
        ...
        for (i = 1; i < 1024 - 1; i++) {
            ...
            while (t < 20) {
                ...
                if (1) {
                    ...
                    ptsTo(_imopVarPre209) := [heapCell#0];
                    ptsTo(_imopVarPre212) := [heapCell#15];
                    ptsTo(_imopVarPre216) := [heapCell#1];
                    ptsTo(argv) := [heapCell#16];
                    ptsTo(heapCell#0) := [heapCell#11];
                    ptsTo(heapCell#1) := [p.f];
                    ptsTo(heapCell#4) := [p.f];
                ...
                }
                {
                    ...
                    if (1) {
                        ...
                        ptsTo(_imopVarPre209) := [heapCell#0];
                        ptsTo(_imopVarPre212) := [heapCell#15];
                        ptsTo(_imopVarPre220) := [heapCell#4];
                        ptsTo(argv) := [heapCell#16];
                        ptsTo(heapCell#0) := [heapCell#11];
                        ptsTo(heapCell#1) := [p.f];
                        ptsTo(heapCell#4) := [p.f];
                ...
                }
                {
                    ...
                    if (1) {
                        ...
                        ptsTo(_imopVarPre209) := [heapCell#0];
                        ptsTo(_imopVarPre212) := [heapCell#15];
                        ptsTo(_imopVarPre224) := [heapCell#7];
                        ptsTo(argv) := [heapCell#16];
                        ptsTo(heapCell#0) := [heapCell#11];
                        ptsTo(heapCell#1) := [p.f];
                        ptsTo(heapCell#4) := [p.f];
