...
ptsTo(u) := [heapCell#4, heapCell#5];
ptsTo(w) := [heapCell#4, heapCell#5];
ptsTo(temp) := [nullCell, heapCell#4, heapCell#5];
ptsTo(delta) := [heapCell#2];
ptsTo(heapCell#4) := [heapCell#3];
ptsTo(heapCell#5) := [heapCell#0];
]*/
...
void init() {
    ...
    ptsTo(delta) := [nullCell];
    ptsTo(_imopVarPre113) := [heapCell#4];
    ptsTo(_imopVarPre117) := [heapCell#5];
    ]*/
    /*OUT: [ptsTo(stdin) := [nullCell];
    ptsTo(stdout) := [nullCell];
    ptsTo(stderr) := [nullCell];
    ...
    ptsTo(_imopVarPre113) := [heapCell#4];
    ptsTo(_imopVarPre117) := [heapCell#5];
    ptsTo(_imopVarPre121) := [heapCell#2];
    ]*/
    /*OUT: [ptsTo(stdin) := [nullCell];
    ptsTo(stdout) := [nullCell];
    ptsTo(stderr) := [nullCell];
    ...
    for (i = 0; i < 2048; i++) {
        ...
        ptsTo(_imopVarPre117) := [heapCell#5];
        ptsTo(_imopVarPre121) := [heapCell#2];
        ptsTo(_imopVarPre125) := [heapCell#3];
        ptsTo(heapCell#4) := [heapCell#3];
        ptsTo(heapCell#5) := [heapCell#0];
        ]*/
        /*OUT: [ptsTo(stdin) := [nullCell];
        ...
        for (i = 1; i < 2048 - 1; i++) {
            ...
            while (epsilon <= diff) {
                ...
                if (i == 1) {
                    ...
                    ptsTo(u) := [heapCell#4, heapCell#5];
                    ptsTo(w) := [heapCell#4, heapCell#5];
                    ptsTo(temp) := [heapCell#4, heapCell#5];
                    ptsTo(delta) := [heapCell#2];
                    ptsTo(fp) := [nullCell];
                    ptsTo(argv) := [heapCell#6];
                    ptsTo(heapCell#4) := [heapCell#3];
