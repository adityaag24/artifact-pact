...
ptsTo(A) := [heapCell#7];
ptsTo(heapCell#1) := [p.f];
ptsTo(heapCell#7) := [heapCell#10];
...
ptsTo(postbox_ivp17) := [nullCell];
ptsTo(A) := [heapCell#7];
ptsTo(p) := [heapCell#11, heapCell#1];
ptsTo(heapCell#1) := [p.f];
ptsTo(heapCell#7) := [heapCell#10];
ptsTo(heapCell#8) := [p.f];
ptsTo(heapCell#11) := [p.f];
...
ptsTo(postbox_ivp17) := [nullCell];
ptsTo(A) := [heapCell#7];
ptsTo(p) := [heapCell#12, heapCell#8];
ptsTo(heapCell#1) := [p.f];
ptsTo(heapCell#7) := [heapCell#10];
ptsTo(heapCell#8) := [p.f];
ptsTo(heapCell#11) := [p.f];
...
int main(int argc, char **argv) {
    ...
    _imopVarPre203 = sizeof(double *) * 1024;
    /*OUT: [ptsTo(stdin) := [nullCell];
    ptsTo(stdout) := [nullCell];
    ptsTo(stderr) := [nullCell];
    ptsTo(globalWorklist) := [nullCell];
    ...
    ptsTo(postbox_ivp17) := [nullCell];
    ptsTo(A) := [nullCell];
    ptsTo(_imopVarPre204) := [heapCell#7];
    ptsTo(argv) := [heapCell#14];
    ]*/
    /*OUT: [ptsTo(stdin) := [nullCell];
    ptsTo(stdout) := [nullCell];
    ...
    for (i = 0; i < 1024; i++) {
        ...
        _imopVarPre207 = sizeof(double) * 1024;
        /*OUT: [ptsTo(stdin) := [nullCell];
        ptsTo(stdout) := [nullCell];
        ptsTo(stderr) := [nullCell];
        ptsTo(globalWorklist) := [nullCell];
        ...
        ptsTo(_imopVarPre204) := [heapCell#7];
        ptsTo(argv) := [heapCell#14];
        ptsTo(_imopVarPre208) := [heapCell#10];
        ptsTo(heapCell#7) := [heapCell#10];
        ]*/
        /*OUT: [ptsTo(stdin) := [nullCell];
        ptsTo(stdout) := [nullCell];
        ...
        for (i = 1; i < 1024 - 1; i++) {
            ...
            while (t < 20) {
                ...
                if (1) {
                    ...
                    ptsTo(A) := [heapCell#7];
                    ptsTo(_imopVarPre204) := [heapCell#7];
                    ptsTo(_imopVarPre213) := [heapCell#12];
                    ptsTo(argv) := [heapCell#14];
                    ptsTo(heapCell#1) := [p.f];
                    ptsTo(heapCell#7) := [heapCell#10];
                    ptsTo(heapCell#8) := [p.f];
                ...
                }
                {
                    ...
                    if (1) {
                        ...
                        ptsTo(A) := [heapCell#7];
                        ptsTo(_imopVarPre204) := [heapCell#7];
                        ptsTo(_imopVarPre217) := [heapCell#11];
                        ptsTo(argv) := [heapCell#14];
                        ptsTo(heapCell#1) := [p.f];
                        ptsTo(heapCell#7) := [heapCell#10];
                        ptsTo(heapCell#8) := [p.f];
                ...
                }
                {
                    ...
                    if (1) {
                        ...
                        ptsTo(A) := [heapCell#7];
                        ptsTo(_imopVarPre204) := [heapCell#7];
                        ptsTo(_imopVarPre221) := [heapCell#8];
                        ptsTo(argv) := [heapCell#14];
                        ptsTo(heapCell#1) := [p.f];
                        ptsTo(heapCell#7) := [heapCell#10];
                        ptsTo(heapCell#8) := [p.f];
