...
ptsTo(table) := [heapCell#3];
ptsTo(x) := [heapCell#2];
ptsTo(y) := [heapCell#4];
ptsTo(heapCell#1) := [nullCell];
ptsTo(heapCell#3) := [heapCell#1];
]*/
...
ptsTo(leftPointer) := [nullCell];
ptsTo(rightPointer) := [nullCell];
ptsTo(table) := [nullCell];
ptsTo(x) := [nullCell];
ptsTo(y) := [nullCell];
ptsTo(argv) := [heapCell#5];
]*/
/*OUT: [ptsTo(stdin) := [nullCell];
ptsTo(stdout) := [nullCell];
ptsTo(stderr) := [nullCell];
...
int main(int argc, char **argv) {
    ...
    ptsTo(_imopVarPre125) := [heapCell#2];
    ptsTo(_imopVarPre128) := [heapCell#4];
    ptsTo(_imopVarPre134) := [heapCell#3];
    ptsTo(argv) := [heapCell#5];
    ]*/
    /*OUT: [ptsTo(stdin) := [nullCell];
    ptsTo(stdout) := [nullCell];
    ...
    for (i = 0; i < size_x + 1; i++) {
        ...
        ptsTo(_imopVarPre134) := [heapCell#3];
        ptsTo(argv) := [heapCell#5];
        ptsTo(_imopVarPre140) := [heapCell#1];
        ptsTo(heapCell#3) := [heapCell#1];
        ]*/
        /*OUT: [ptsTo(stdin) := [nullCell];
        ptsTo(stdout) := [nullCell];
