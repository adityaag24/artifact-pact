...
ptsTo(heapCell#1) := [heapCell#11];
ptsTo(heapCell#5) := [heapCell#2];
...
int main(int argc, char **argv) {
    ...
    ptsTo(A) := [nullCell];
    ptsTo(B) := [nullCell];
    ptsTo(_imopVarPre209) := [heapCell#1];
    ptsTo(argv) := [heapCell#14];
    ]*/
    /*OUT: [ptsTo(stdin) := [nullCell];
    ptsTo(stdout) := [nullCell];
        ...
        for (i = 1; i < 16384 - 1; i++) {
            ...
            while (t < 50) {
                ...
                if (1) {
                    ...
                    ptsTo(_imopVarPre209) := [heapCell#1];
                    ptsTo(_imopVarPre212) := [heapCell#5];
                    ptsTo(_imopVarPre216) := [heapCell#13];
                    ptsTo(argv) := [heapCell#14];
                    ptsTo(heapCell#0) := [p.f];
                    ptsTo(heapCell#1) := [heapCell#11];
                    ptsTo(heapCell#5) := [heapCell#2];
                ...
                }
                {
                    ...
                    if (1) {
                        ...
                        ptsTo(_imopVarPre209) := [heapCell#1];
                        ptsTo(_imopVarPre212) := [heapCell#5];
                        ptsTo(_imopVarPre220) := [heapCell#0];
                        ptsTo(argv) := [heapCell#14];
                        ptsTo(heapCell#0) := [p.f];
                        ptsTo(heapCell#1) := [heapCell#11];
                        ptsTo(heapCell#5) := [heapCell#2];
