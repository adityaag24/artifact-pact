...
ptsTo(A) := [heapCell#1];
ptsTo(B) := [heapCell#8];
ptsTo(heapCell#4) := [p.f];
ptsTo(heapCell#10) := [p.f];
ptsTo(heapCell#12) := [p.f];
ptsTo(heapCell#13) := [p.f];
]*/
/*OUT: [ptsTo(stdin) := [nullCell];
ptsTo(stdout) := [nullCell];
ptsTo(stderr) := [nullCell];
...
ptsTo(A) := [heapCell#1];
ptsTo(B) := [heapCell#8];
ptsTo(p) := [heapCell#13, heapCell#10];
ptsTo(heapCell#4) := [p.f];
ptsTo(heapCell#10) := [p.f];
ptsTo(heapCell#12) := [p.f];
ptsTo(heapCell#13) := [p.f];
...
ptsTo(A) := [heapCell#1];
ptsTo(B) := [heapCell#8];
ptsTo(p) := [heapCell#12, heapCell#4];
ptsTo(heapCell#4) := [p.f];
ptsTo(heapCell#10) := [p.f];
ptsTo(heapCell#12) := [p.f];
ptsTo(heapCell#13) := [p.f];
...
int main(int argc, char **argv) {
    ...
    _imopVarPre203 = calloc(1024, _imopVarPre202);
    /*OUT: [ptsTo(stdin) := [nullCell];
    ptsTo(stdout) := [nullCell];
    ptsTo(stderr) := [nullCell];
    ptsTo(globalWorklist) := [nullCell];
    ...
    ptsTo(B) := [nullCell];
    ptsTo(argv) := [heapCell#14];
    ptsTo(_imopVarPre203) := [heapCell#1];
    ]*/
    /*OUT: [ptsTo(stdin) := [nullCell];
    ptsTo(stdout) := [nullCell];
    ptsTo(stderr) := [nullCell];
    ...
    _imopVarPre206 = calloc(1024, _imopVarPre205);
    /*OUT: [ptsTo(stdin) := [nullCell];
    ptsTo(stdout) := [nullCell];
    ptsTo(stderr) := [nullCell];
    ptsTo(globalWorklist) := [nullCell];
    ...
    ptsTo(argv) := [heapCell#14];
    ptsTo(_imopVarPre203) := [heapCell#1];
    ptsTo(_imopVarPre206) := [heapCell#8];
    ]*/
    /*OUT: [ptsTo(stdin) := [nullCell];
    ptsTo(stdout) := [nullCell];
    ptsTo(stderr) := [nullCell];
        ...
        for (i = 1; i < 1024 - 1; i++) {
            ...
            while (t < 20) {
                ...
                if (1) {
                    ...
                    ptsTo(A) := [heapCell#1];
                    ptsTo(B) := [heapCell#8];
                    ptsTo(_imopVarPre210) := [heapCell#12];
                    ptsTo(argv) := [heapCell#14];
                    ptsTo(_imopVarPre203) := [heapCell#1];
                    ptsTo(_imopVarPre206) := [heapCell#8];
                    ptsTo(heapCell#4) := [p.f];
                ...
                }
                {
                    ...
                    if (1) {
                        ...
                        ptsTo(A) := [heapCell#1];
                        ptsTo(B) := [heapCell#8];
                        ptsTo(_imopVarPre214) := [heapCell#10];
                        ptsTo(argv) := [heapCell#14];
                        ptsTo(_imopVarPre203) := [heapCell#1];
                        ptsTo(_imopVarPre206) := [heapCell#8];
                        ptsTo(heapCell#4) := [p.f];
                ...
                A[i] = B[i];
                {
                    ...
                    if (1) {
                        ...
                        ptsTo(A) := [heapCell#1];
                        ptsTo(B) := [heapCell#8];
                        ptsTo(_imopVarPre218) := [heapCell#4];
                        ptsTo(argv) := [heapCell#14];
                        ptsTo(_imopVarPre203) := [heapCell#1];
                        ptsTo(_imopVarPre206) := [heapCell#8];
                        ptsTo(heapCell#4) := [p.f];
                ...
                }
                {
                    ...
                    if (1) {
                        ...
                        ptsTo(A) := [heapCell#1];
                        ptsTo(B) := [heapCell#8];
                        ptsTo(_imopVarPre222) := [heapCell#13];
                        ptsTo(argv) := [heapCell#14];
                        ptsTo(_imopVarPre203) := [heapCell#1];
                        ptsTo(_imopVarPre206) := [heapCell#8];
                        ptsTo(heapCell#4) := [p.f];
