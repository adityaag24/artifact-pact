...
ptsTo(u) := [heapCell#9, heapCell#17];
ptsTo(w) := [heapCell#9, heapCell#17];
ptsTo(temp) := [nullCell, heapCell#17];
ptsTo(delta) := [heapCell#23];
ptsTo(heapCell#9) := [heapCell#4];
ptsTo(heapCell#17) := [heapCell#21];
]*/
/*OUT: [ptsTo(stdin) := [nullCell];
ptsTo(stdout) := [nullCell];
ptsTo(stderr) := [nullCell];
...
void init() {
    ...
    ptsTo(temp) := [nullCell];
    ptsTo(delta) := [nullCell];
    ptsTo(_imopVarPre325) := [heapCell#17];
    ]*/
    /*OUT: [ptsTo(stdin) := [nullCell];
    ptsTo(stdout) := [nullCell];
    ptsTo(stderr) := [nullCell];
    ...
    ptsTo(delta) := [nullCell];
    ptsTo(_imopVarPre325) := [heapCell#17];
    ptsTo(_imopVarPre329) := [heapCell#9];
    ]*/
    /*OUT: [ptsTo(stdin) := [nullCell];
    ptsTo(stdout) := [nullCell];
    ptsTo(stderr) := [nullCell];
    ...
    ptsTo(_imopVarPre325) := [heapCell#17];
    ptsTo(_imopVarPre329) := [heapCell#9];
    ptsTo(_imopVarPre333) := [heapCell#23];
    ]*/
    /*OUT: [ptsTo(stdin) := [nullCell];
    ptsTo(stdout) := [nullCell];
    ptsTo(stderr) := [nullCell];
    ...
    for (i = 0; i < 512; i++) {
        ...
        ptsTo(_imopVarPre329) := [heapCell#9];
        ptsTo(_imopVarPre333) := [heapCell#23];
        ptsTo(_imopVarPre337) := [heapCell#21];
        ptsTo(heapCell#9) := [heapCell#4];
        ptsTo(heapCell#17) := [heapCell#21];
        ]*/
        /*OUT: [ptsTo(stdin) := [nullCell];
        ...
        ptsTo(_imopVarPre333) := [heapCell#23];
        ptsTo(_imopVarPre337) := [heapCell#21];
        ptsTo(_imopVarPre341) := [heapCell#4];
        ptsTo(heapCell#9) := [heapCell#4];
        ptsTo(heapCell#17) := [heapCell#21];
        ]*/
        /*OUT: [ptsTo(stdin) := [nullCell];
        ...
        for (i = 1; i < 512 - 1; i++) {
            ...
            while (epsilon <= diff) {
                ...
                if (1) {
                    ...
                    ptsTo(fp) := [nullCell];
                    ptsTo(argv) := [heapCell#30];
                    ptsTo(_imopVarPre348) := [heapCell#13];
                    ptsTo(heapCell#9) := [heapCell#4];
                    ptsTo(heapCell#17) := [heapCell#21];
                    ]*/
                    /*OUT: [ptsTo(stdin) := [nullCell];
