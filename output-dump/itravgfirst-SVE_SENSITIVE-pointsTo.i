...
/*OUT: [ptsTo(stdin) := [nullCell];
ptsTo(stdout) := [nullCell];
ptsTo(stderr) := [nullCell];
ptsTo(globalWorklist) := [nullCell];
ptsTo(oldMessages) := [nullCell];
ptsTo(newMessages) := [nullCell];
ptsTo(continuationFunctionPointer) := [nullCell];
ptsTo(postbox_ivp17) := [nullCell];
ptsTo(comm_ivp17) := [nullCell];
ptsTo(newA) := [heapCell#6, heapCell#21];
ptsTo(oldA) := [heapCell#6, heapCell#21];
ptsTo(diff) := [heapCell#13];
ptsTo(temp) := [heapCell#6, nullCell];
ptsTo(heapCell#12) := [p.f];
ptsTo(heapCell#21) := [nullCell];
]*/
/*OUT: [ptsTo(stdin) := [nullCell];
ptsTo(stdout) := [nullCell];
ptsTo(stderr) := [nullCell];
...
int main() {
    ...
    unsigned long int _imopVarPre326;
    /*OUT: [ptsTo(stdin) := [nullCell];
    ptsTo(stdout) := [nullCell];
    ptsTo(stderr) := [nullCell];
    ptsTo(globalWorklist) := [nullCell];
    ...
    _imopVarPre327 = calloc(_imopVarPre326, _imopVarPre325);
    /*OUT: [ptsTo(stdin) := [nullCell];
    ptsTo(stdout) := [nullCell];
    ptsTo(stderr) := [nullCell];
    ptsTo(globalWorklist) := [nullCell];
    ...
    ptsTo(diff) := [nullCell];
    ptsTo(temp) := [nullCell];
    ptsTo(_imopVarPre327) := [heapCell#21];
    ]*/
    /*OUT: [ptsTo(stdin) := [nullCell];
    ptsTo(stdout) := [nullCell];
    ptsTo(stderr) := [nullCell];
    ...
    ptsTo(comm_ivp17) := [nullCell];
    ptsTo(newA) := [nullCell];
    ptsTo(oldA) := [heapCell#21];
    ptsTo(diff) := [nullCell];
    ptsTo(temp) := [nullCell];
    ptsTo(_imopVarPre327) := [heapCell#21];
    ]*/
    oldA = (double *) _imopVarPre327;
    /*OUT: [ptsTo(stdin) := [nullCell];
    ptsTo(stdout) := [nullCell];
    ptsTo(stderr) := [nullCell];
    ptsTo(globalWorklist) := [nullCell];
    ...
    _imopVarPre333 = calloc(_imopVarPre332, _imopVarPre331);
    /*OUT: [ptsTo(stdin) := [nullCell];
    ptsTo(stdout) := [nullCell];
    ptsTo(stderr) := [nullCell];
    ptsTo(globalWorklist) := [nullCell];
    ...
    ptsTo(temp) := [nullCell];
    ptsTo(_imopVarPre327) := [heapCell#21];
    ptsTo(_imopVarPre333) := [heapCell#6];
    ]*/
    /*OUT: [ptsTo(stdin) := [nullCell];
    ptsTo(stdout) := [nullCell];
    ptsTo(stderr) := [nullCell];
    ...
    _imopVarPre339 = calloc(_imopVarPre338, _imopVarPre337);
    /*OUT: [ptsTo(stdin) := [nullCell];
    ptsTo(stdout) := [nullCell];
    ptsTo(stderr) := [nullCell];
    ptsTo(globalWorklist) := [nullCell];
    ...
    ptsTo(_imopVarPre327) := [heapCell#21];
    ptsTo(_imopVarPre333) := [heapCell#6];
    ptsTo(_imopVarPre339) := [heapCell#13];
    ]*/
    /*OUT: [ptsTo(stdin) := [nullCell];
    ptsTo(stdout) := [nullCell];
    ptsTo(stderr) := [nullCell];
        ...
        for (i = 1; i <= 64; i++) {
            ...
            while (epsilon <= delta) {
                ...
                if (1) {
                    ...
                    ptsTo(_imopVarPre333) := [heapCell#6];
                    ptsTo(_imopVarPre339) := [heapCell#13];
                    ptsTo(_imopVarPre344) := [heapCell#5];
                    ptsTo(heapCell#12) := [p.f];
                    ptsTo(heapCell#21) := [nullCell];
                    ]*/
                    /*OUT: [ptsTo(stdin) := [nullCell];
                    ...
                    ptsTo(_imopVarPre339) := [heapCell#13];
                    ptsTo(_imopVarPre344) := [heapCell#5];
                    ptsTo(ptr) := [heapCell#5];
                    ptsTo(heapCell#12) := [p.f];
                    ptsTo(heapCell#21) := [nullCell];
                    ]*/
                    double *ptr = (double *) _imopVarPre344;
                    /*OUT: [ptsTo(stdin) := [nullCell];
                    ptsTo(stdout) := [nullCell];
                    ptsTo(stderr) := [nullCell];
                    ptsTo(globalWorklist) := [nullCell];
                ...
                }
                {
                    ...
                    if (i == 1) {
                        ...
                        mySignalAll(_imopVarPre346, 0, 0);
                        /*OUT: [ptsTo(stdin) := [nullCell];
                        ptsTo(stdout) := [nullCell];
                        ptsTo(stderr) := [nullCell];
                        ptsTo(globalWorklist) := [nullCell];
                ...
                }
                {
                    ...
                    if (i != 1) {
                        ...
                        _imopVarPre349 = n_iters * sizeof(int);
                        /*OUT: [ptsTo(stdin) := [nullCell];
                        ptsTo(stdout) := [nullCell];
                        ptsTo(stderr) := [nullCell];
                        ptsTo(globalWorklist) := [nullCell];
                        ...
                        ptsTo(_imopVarPre333) := [heapCell#6];
                        ptsTo(_imopVarPre339) := [heapCell#13];
                        ptsTo(_imopVarPre350) := [heapCell#12];
                        ptsTo(redVar) := [delta];
                        ptsTo(initialValue) := [nullCell];
                        ptsTo(heapCell#12) := [p.f];
                        ptsTo(heapCell#21) := [nullCell];
                        ...
                        myWait(_imopVarPre352, n_iters, q);
                        /*OUT: [ptsTo(stdin) := [nullCell];
                        ptsTo(stdout) := [nullCell];
                        ptsTo(stderr) := [nullCell];
                        ptsTo(globalWorklist) := [nullCell];
