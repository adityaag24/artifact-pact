...
ptsTo(A) := [heapCell#11];
ptsTo(B) := [heapCell#5];
ptsTo(heapCell#5) := [heapCell#3];
ptsTo(heapCell#7) := [p.f];
ptsTo(heapCell#10) := [p.f];
ptsTo(heapCell#11) := [heapCell#6];
ptsTo(heapCell#14) := [p.f];
ptsTo(heapCell#15) := [p.f];
]*/
/*OUT: [ptsTo(stdin) := [nullCell];
ptsTo(stdout) := [nullCell];
ptsTo(stderr) := [nullCell];
...
ptsTo(A) := [heapCell#11];
ptsTo(B) := [heapCell#5];
ptsTo(p) := [heapCell#10, heapCell#15];
ptsTo(heapCell#5) := [heapCell#3];
ptsTo(heapCell#7) := [p.f];
ptsTo(heapCell#10) := [p.f];
ptsTo(heapCell#11) := [heapCell#6];
...
ptsTo(A) := [heapCell#11];
ptsTo(B) := [heapCell#5];
ptsTo(p) := [heapCell#14, heapCell#7];
ptsTo(heapCell#5) := [heapCell#3];
ptsTo(heapCell#7) := [p.f];
ptsTo(heapCell#10) := [p.f];
ptsTo(heapCell#11) := [heapCell#6];
...
void mySignal(int e, int N , int *p) {
    ...
    ptsTo(A) := [heapCell#11];
    ptsTo(B) := [heapCell#5];
    ptsTo(p) := [heapCell#7, heapCell#14];
    ptsTo(heapCell#5) := [heapCell#3];
    ptsTo(heapCell#7) := [p.f];
    ptsTo(heapCell#10) := [p.f];
    ptsTo(heapCell#11) := [heapCell#6];
...
void init() {
    ...
    for (i = 0; i < 16384; i++) {
        ...
        ptsTo(A) := [heapCell#11];
        ptsTo(B) := [heapCell#5];
        ptsTo(_imopVarPre203) := [heapCell#6];
        ptsTo(heapCell#5) := [heapCell#3];
        ptsTo(heapCell#11) := [heapCell#6];
        ]*/
        /*OUT: [ptsTo(stdin) := [nullCell];
...
int main(int argc, char **argv) {
    ...
    ptsTo(A) := [nullCell];
    ptsTo(B) := [nullCell];
    ptsTo(_imopVarPre209) := [heapCell#11];
    ptsTo(argv) := [heapCell#16];
    ]*/
    /*OUT: [ptsTo(stdin) := [nullCell];
    ptsTo(stdout) := [nullCell];
    ...
    ptsTo(B) := [nullCell];
    ptsTo(_imopVarPre209) := [heapCell#11];
    ptsTo(_imopVarPre212) := [heapCell#5];
    ptsTo(argv) := [heapCell#16];
    ]*/
    /*OUT: [ptsTo(stdin) := [nullCell];
    ptsTo(stdout) := [nullCell];
        ...
        for (i = 1; i < 16384 - 1; i++) {
            ...
            while (t < 50) {
                ...
                if (1) {
                    ...
                    ptsTo(_imopVarPre209) := [heapCell#11];
                    ptsTo(_imopVarPre212) := [heapCell#5];
                    ptsTo(_imopVarPre216) := [heapCell#7];
                    ptsTo(argv) := [heapCell#16];
                    ptsTo(heapCell#5) := [heapCell#3];
                    ptsTo(heapCell#7) := [p.f];
                    ptsTo(heapCell#10) := [p.f];
                ...
                }
                {
                    ...
                    if (1) {
                        ...
                        ptsTo(_imopVarPre209) := [heapCell#11];
                        ptsTo(_imopVarPre212) := [heapCell#5];
                        ptsTo(_imopVarPre220) := [heapCell#15];
                        ptsTo(argv) := [heapCell#16];
                        ptsTo(heapCell#5) := [heapCell#3];
                        ptsTo(heapCell#7) := [p.f];
                        ptsTo(heapCell#10) := [p.f];
                ...
                }
                {
                    ...
                    if (1) {
                        ...
                        ptsTo(_imopVarPre209) := [heapCell#11];
                        ptsTo(_imopVarPre212) := [heapCell#5];
                        ptsTo(_imopVarPre224) := [heapCell#14];
                        ptsTo(argv) := [heapCell#16];
                        ptsTo(heapCell#5) := [heapCell#3];
                        ptsTo(heapCell#7) := [p.f];
                        ptsTo(heapCell#10) := [p.f];
                ...
                }
                {
                    ...
                    if (1) {
                        ...
                        ptsTo(_imopVarPre209) := [heapCell#11];
                        ptsTo(_imopVarPre212) := [heapCell#5];
                        ptsTo(_imopVarPre228) := [heapCell#10];
                        ptsTo(argv) := [heapCell#16];
                        ptsTo(heapCell#5) := [heapCell#3];
                        ptsTo(heapCell#7) := [p.f];
                        ptsTo(heapCell#10) := [p.f];
