...
void init(){
    int i,j;
    srandom(1000);
    A = (float **)malloc(sizeof(float *)*1024);
    B = (float **)malloc(sizeof(float *)*1024);
    C = (float **)malloc(sizeof(float *)*1024);
    D = (float **)malloc(sizeof(float *)*1024);
    E = (float **)malloc(sizeof(float *)*1024);
    F = (float **)malloc(sizeof(float *)*1024);
    G = (float **)malloc(sizeof(float *)*1024);
    for(i=0;i<1024;i++){
        A[i] = (float *)malloc(sizeof(float) * 1024);
        B[i] = (float *)malloc(sizeof(float) * 1024);
        C[i] = (float *)malloc(sizeof(float) * 1024);
        D[i] = (float *)malloc(sizeof(float) * 1024);
        E[i] = (float *)malloc(sizeof(float) * 1024);
        F[i] = (float *)malloc(sizeof(float) * 1024);
        G[i] = (float *)malloc(sizeof(float) * 1024);
    }
    for(i=0;i<1024;i++){
        for(j=0;j<1024;j++){
