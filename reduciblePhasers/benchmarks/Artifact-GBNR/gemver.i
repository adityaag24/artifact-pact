...
int main(){
 A = calloc(16384, sizeof(double *));
 int i;
 for (i = 0; i < 16384; i++) {
  A[i] = calloc(16384, sizeof(double));
 }
 u1 = calloc(16384, sizeof(double));
 v1 = calloc(16384, sizeof(double));
 u2 = calloc(16384, sizeof(double));
 v2 = calloc(16384, sizeof(double));
 w = calloc(16384, sizeof(double));
 x = calloc(16384, sizeof(double));
 y = calloc(16384, sizeof(double));
 z = calloc(16384, sizeof(double));
  init();
    double itime,ftime;
    init();
    itime = omp_get_wtime();
