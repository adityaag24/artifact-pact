...
void init() {
    ...
    void *_imopVarPre113;
    _imopVarPre112 = sizeof(float *) * 1024;
    _imopVarPre113 = malloc(_imopVarPre112);
    A = (float **) _imopVarPre113;
    unsigned long int _imopVarPre116;
    void *_imopVarPre117;
    _imopVarPre116 = sizeof(float *) * 1024;
    _imopVarPre117 = malloc(_imopVarPre116);
    B = (float **) _imopVarPre117;
    unsigned long int _imopVarPre120;
    void *_imopVarPre121;
    _imopVarPre120 = sizeof(float *) * 1024;
    _imopVarPre121 = malloc(_imopVarPre120);
    C = (float **) _imopVarPre121;
    unsigned long int _imopVarPre124;
    void *_imopVarPre125;
    _imopVarPre124 = sizeof(float *) * 1024;
    _imopVarPre125 = malloc(_imopVarPre124);
    D = (float **) _imopVarPre125;
    unsigned long int _imopVarPre128;
    void *_imopVarPre129;
    _imopVarPre128 = sizeof(float *) * 1024;
    _imopVarPre129 = malloc(_imopVarPre128);
    E = (float **) _imopVarPre129;
    unsigned long int _imopVarPre132;
    void *_imopVarPre133;
    _imopVarPre132 = sizeof(float *) * 1024;
    _imopVarPre133 = malloc(_imopVarPre132);
    F = (float **) _imopVarPre133;
    unsigned long int _imopVarPre136;
    void *_imopVarPre137;
    _imopVarPre136 = sizeof(float *) * 1024;
    _imopVarPre137 = malloc(_imopVarPre136);
    G = (float **) _imopVarPre137;
    for (i = 0; i < 1024; i++) {
        unsigned long int _imopVarPre140;
        void *_imopVarPre141;
        _imopVarPre140 = sizeof(float) * 1024;
        _imopVarPre141 = malloc(_imopVarPre140);
        A[i] = (float *) _imopVarPre141;
        unsigned long int _imopVarPre144;
        void *_imopVarPre145;
        _imopVarPre144 = sizeof(float) * 1024;
        _imopVarPre145 = malloc(_imopVarPre144);
        B[i] = (float *) _imopVarPre145;
        unsigned long int _imopVarPre148;
        void *_imopVarPre149;
        _imopVarPre148 = sizeof(float) * 1024;
        _imopVarPre149 = malloc(_imopVarPre148);
        C[i] = (float *) _imopVarPre149;
        unsigned long int _imopVarPre152;
        void *_imopVarPre153;
        _imopVarPre152 = sizeof(float) * 1024;
        _imopVarPre153 = malloc(_imopVarPre152);
        D[i] = (float *) _imopVarPre153;
        unsigned long int _imopVarPre156;
        void *_imopVarPre157;
        _imopVarPre156 = sizeof(float) * 1024;
        _imopVarPre157 = malloc(_imopVarPre156);
        E[i] = (float *) _imopVarPre157;
        unsigned long int _imopVarPre160;
        void *_imopVarPre161;
        _imopVarPre160 = sizeof(float) * 1024;
        _imopVarPre161 = malloc(_imopVarPre160);
        F[i] = (float *) _imopVarPre161;
        unsigned long int _imopVarPre164;
        void *_imopVarPre165;
        _imopVarPre164 = sizeof(float) * 1024;
        _imopVarPre165 = malloc(_imopVarPre164);
        G[i] = (float *) _imopVarPre165;
    }
    for (i = 0; i < 1024; i++) {
        for (j = 0; j < 1024; j++) {
            signed long int _imopVarPre167;
            _imopVarPre167 = random();
            A[i][j] = (float) _imopVarPre167 / 2147483647;
            signed long int _imopVarPre169;
            _imopVarPre169 = random();
            B[i][j] = (float) _imopVarPre169 / 2147483647;
            C[i][j] = 0.0;
            signed long int _imopVarPre171;
            _imopVarPre171 = random();
            D[i][j] = (float) _imopVarPre171 / 2147483647;
            signed long int _imopVarPre173;
            _imopVarPre173 = random();
            E[i][j] = (float) _imopVarPre173 / 2147483647;
            F[i][j] = 0.0;
            G[i][j] = 0.0;
        }
    }
...
struct master_env {
    struct internal_tf_ivp28 *internal_vf_ivp29;
} ;
struct internal_tf_ivp28 {
    void ( *continuation )(struct Clsr *);
    struct ENV_PRIVATE_ivp8 *envp_c_ivp3;
} ;
void ompfor_ivp30(struct Clsr *clsr_v_ivp1);
void clsr_ivp50(struct Clsr *clsr_v_ivp1);
...
// #pragma omp dummyFlush BARRIER_START
#pragma omp barrier
        _imopVarPre49 = omp_get_thread_num();
        int tid_ivp17 = _imopVarPre49;
...
#pragma omp for private(i, j, k) nowait
        for (i = 0; i < 1024; i++) {
            ...
            envp_c_ivp3->k = (env_p_ivp9->k);
            envp_c_ivp3->j = (env_p_ivp9->j);
            envp_c_ivp3->i = i;
            void ( *_imopVarPre33 )(struct Clsr *clsr_v_ivp1);
            struct Clsr *_imopVarPre34;
            _imopVarPre33 = &ompfor_ivp30;
            _imopVarPre34 = createClosure(NORMAL, _imopVarPre33, i);
            struct Clsr *clsr_v_ivp1 = _imopVarPre34;
            unsigned long int _imopVarPre37;
            void *_imopVarPre38;
            _imopVarPre37 = sizeof(struct master_env);
            _imopVarPre38 = malloc(_imopVarPre37);
            clsr_v_ivp1->environment = (struct master_env *) _imopVarPre38;
            unsigned long int _imopVarPre41;
            void *_imopVarPre42;
            _imopVarPre41 = sizeof(struct internal_tf_ivp28);
            _imopVarPre42 = malloc(_imopVarPre41);
            clsr_v_ivp1->environment->internal_vf_ivp29 = (struct internal_tf_ivp28 *) _imopVarPre42;
            clsr_v_ivp1->environment->internal_vf_ivp29->continuation = &lastFunction;
            int _imopVarPre44;
            _imopVarPre44 = omp_get_thread_num();
            if (i < leftPointer[_imopVarPre44]) {
                int _imopVarPre45;
                _imopVarPre45 = omp_get_thread_num();
                leftPointer[_imopVarPre45] = i;
            }
            int _imopVarPre47;
            _imopVarPre47 = omp_get_thread_num();
            if (i > rightPointer[_imopVarPre47]) {
                int _imopVarPre48;
                _imopVarPre48 = omp_get_thread_num();
                rightPointer[_imopVarPre48] = i;
            }
            readyWorkList[i] = clsr_v_ivp1;
            clsr_v_ivp1->environment->internal_vf_ivp29->envp_c_ivp3 = envp_c_ivp3;
        }
// #pragma omp dummyFlush BARRIER_START
#pragma omp barrier
    ...
    _imopVarPre175 = (ftime - itime);
    fprintf(stdout, "Run time = %lf seconds\n", _imopVarPre175);
    return 0;
}
void ompfor_ivp30(struct Clsr *clsr_v_ivp1) {
    for ((clsr_v_ivp1->environment->internal_vf_ivp29->envp_c_ivp3->j) = 0; (clsr_v_ivp1->environment->internal_vf_ivp29->envp_c_ivp3->j) < 1024; (clsr_v_ivp1->environment->internal_vf_ivp29->envp_c_ivp3->j)++) {
        for ((clsr_v_ivp1->environment->internal_vf_ivp29->envp_c_ivp3->k) = 0; (clsr_v_ivp1->environment->internal_vf_ivp29->envp_c_ivp3->k) < 1024; (clsr_v_ivp1->environment->internal_vf_ivp29->envp_c_ivp3->k)++) {
            C[(clsr_v_ivp1->environment->internal_vf_ivp29->envp_c_ivp3->i)][(clsr_v_ivp1->environment->internal_vf_ivp29->envp_c_ivp3->j)] += A[(clsr_v_ivp1->environment->internal_vf_ivp29->envp_c_ivp3->i)][(clsr_v_ivp1->environment->internal_vf_ivp29->envp_c_ivp3->k)] * B[(clsr_v_ivp1->environment->internal_vf_ivp29->envp_c_ivp3->k)][(clsr_v_ivp1->environment->internal_vf_ivp29->envp_c_ivp3->j)];
            F[(clsr_v_ivp1->environment->internal_vf_ivp29->envp_c_ivp3->i)][(clsr_v_ivp1->environment->internal_vf_ivp29->envp_c_ivp3->j)] += D[(clsr_v_ivp1->environment->internal_vf_ivp29->envp_c_ivp3->i)][(clsr_v_ivp1->environment->internal_vf_ivp29->envp_c_ivp3->k)] * E[(clsr_v_ivp1->environment->internal_vf_ivp29->envp_c_ivp3->k)][(clsr_v_ivp1->environment->internal_vf_ivp29->envp_c_ivp3->j)];
        }
    }
    clsr_v_ivp1->fptr = &clsr_ivp50;
    mWaitAll(clsr_v_ivp1);
}
void clsr_ivp50(struct Clsr *clsr_v_ivp1) {
    for ((clsr_v_ivp1->environment->internal_vf_ivp29->envp_c_ivp3->j) = 0; (clsr_v_ivp1->environment->internal_vf_ivp29->envp_c_ivp3->j) < 1024; (clsr_v_ivp1->environment->internal_vf_ivp29->envp_c_ivp3->j)++) {
        for ((clsr_v_ivp1->environment->internal_vf_ivp29->envp_c_ivp3->k) = 0; (clsr_v_ivp1->environment->internal_vf_ivp29->envp_c_ivp3->k) < 1024; (clsr_v_ivp1->environment->internal_vf_ivp29->envp_c_ivp3->k)++) {
            G[(clsr_v_ivp1->environment->internal_vf_ivp29->envp_c_ivp3->i)][(clsr_v_ivp1->environment->internal_vf_ivp29->envp_c_ivp3->j)] += C[(clsr_v_ivp1->environment->internal_vf_ivp29->envp_c_ivp3->i)][(clsr_v_ivp1->environment->internal_vf_ivp29->envp_c_ivp3->k)] * F[(clsr_v_ivp1->environment->internal_vf_ivp29->envp_c_ivp3->k)][(clsr_v_ivp1->environment->internal_vf_ivp29->envp_c_ivp3->j)];
        }
    }
    clsr_v_ivp1->fptr = clsr_v_ivp1->environment->internal_vf_ivp29->continuation;
    clsr_v_ivp1->fptr(clsr_v_ivp1);
}
