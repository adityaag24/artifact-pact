...
void ompfor_ivp32(struct Clsr *clsr_v_ivp1);
void clsr_ivp53(struct Clsr *clsr_v_ivp1);
void clsr_ivp54(struct Clsr *clsr_v_ivp1);
int main() {
    unsigned long int _imopVarPre111;
    void *_imopVarPre112;
    _imopVarPre111 = sizeof(double *);
    _imopVarPre112 = calloc(16384, _imopVarPre111);
    A = _imopVarPre112;
    int i;
    for (i = 0; i < 16384; i++) {
        unsigned long int _imopVarPre114;
        void *_imopVarPre115;
        _imopVarPre114 = sizeof(double);
        _imopVarPre115 = calloc(16384, _imopVarPre114);
        A[i] = _imopVarPre115;
    }
    unsigned long int _imopVarPre117;
    void *_imopVarPre118;
    _imopVarPre117 = sizeof(double);
    _imopVarPre118 = calloc(16384, _imopVarPre117);
    u1 = _imopVarPre118;
    unsigned long int _imopVarPre120;
    void *_imopVarPre121;
    _imopVarPre120 = sizeof(double);
    _imopVarPre121 = calloc(16384, _imopVarPre120);
    v1 = _imopVarPre121;
    unsigned long int _imopVarPre123;
    void *_imopVarPre124;
    _imopVarPre123 = sizeof(double);
    _imopVarPre124 = calloc(16384, _imopVarPre123);
    u2 = _imopVarPre124;
    unsigned long int _imopVarPre126;
    void *_imopVarPre127;
    _imopVarPre126 = sizeof(double);
    _imopVarPre127 = calloc(16384, _imopVarPre126);
    v2 = _imopVarPre127;
    unsigned long int _imopVarPre129;
    void *_imopVarPre130;
    _imopVarPre129 = sizeof(double);
    _imopVarPre130 = calloc(16384, _imopVarPre129);
    w = _imopVarPre130;
    unsigned long int _imopVarPre132;
    void *_imopVarPre133;
    _imopVarPre132 = sizeof(double);
    _imopVarPre133 = calloc(16384, _imopVarPre132);
    x = _imopVarPre133;
    unsigned long int _imopVarPre135;
    void *_imopVarPre136;
    _imopVarPre135 = sizeof(double);
    _imopVarPre136 = calloc(16384, _imopVarPre135);
    y = _imopVarPre136;
    unsigned long int _imopVarPre138;
    void *_imopVarPre139;
    _imopVarPre138 = sizeof(double);
    _imopVarPre139 = calloc(16384, _imopVarPre138);
    z = _imopVarPre139;
    init();
    double itime;
    double ftime;
...
// #pragma omp dummyFlush BARRIER_START
#pragma omp barrier
        _imopVarPre52 = omp_get_thread_num();
        int tid_ivp17 = _imopVarPre52;
...
#pragma omp for private(i, j) nowait
        for (i = 0; i < 16384; i++) {
            ...
            envp_c_ivp3->i = i;
            void ( *_imopVarPre36 )(struct Clsr *clsr_v_ivp1);
            struct Clsr *_imopVarPre37;
            _imopVarPre36 = &ompfor_ivp32;
            _imopVarPre37 = createClosure(NORMAL, _imopVarPre36, i);
            struct Clsr *clsr_v_ivp1 = _imopVarPre37;
            unsigned long int _imopVarPre40;
            void *_imopVarPre41;
            _imopVarPre40 = sizeof(struct master_env);
            _imopVarPre41 = malloc(_imopVarPre40);
            clsr_v_ivp1->environment = (struct master_env *) _imopVarPre41;
            unsigned long int _imopVarPre44;
            void *_imopVarPre45;
            _imopVarPre44 = sizeof(struct internal_tf_ivp30);
            _imopVarPre45 = malloc(_imopVarPre44);
            clsr_v_ivp1->environment->internal_vf_ivp31 = (struct internal_tf_ivp30 *) _imopVarPre45;
            clsr_v_ivp1->environment->internal_vf_ivp31->continuation = &lastFunction;
            int _imopVarPre47;
            _imopVarPre47 = omp_get_thread_num();
            if (i < leftPointer[_imopVarPre47]) {
                int _imopVarPre48;
                _imopVarPre48 = omp_get_thread_num();
                leftPointer[_imopVarPre48] = i;
            }
            int _imopVarPre50;
            _imopVarPre50 = omp_get_thread_num();
            if (i > rightPointer[_imopVarPre50]) {
                int _imopVarPre51;
                _imopVarPre51 = omp_get_thread_num();
                rightPointer[_imopVarPre51] = i;
            }
...
#pragma omp barrier
    ...
    _imopVarPre141 = (ftime - itime);
    fprintf(stdout, "Run time = %lf seconds\n", _imopVarPre141);
}
void ompfor_ivp32(struct Clsr *clsr_v_ivp1) {
    for ((clsr_v_ivp1->environment->internal_vf_ivp31->envp_c_ivp3->j) = 0; (clsr_v_ivp1->environment->internal_vf_ivp31->envp_c_ivp3->j) < 16384; (clsr_v_ivp1->environment->internal_vf_ivp31->envp_c_ivp3->j)++) {
        A[(clsr_v_ivp1->environment->internal_vf_ivp31->envp_c_ivp3->i)][(clsr_v_ivp1->environment->internal_vf_ivp31->envp_c_ivp3->j)] = A[(clsr_v_ivp1->environment->internal_vf_ivp31->envp_c_ivp3->i)][(clsr_v_ivp1->environment->internal_vf_ivp31->envp_c_ivp3->j)] + u1[(clsr_v_ivp1->environment->internal_vf_ivp31->envp_c_ivp3->i)] * v1[(clsr_v_ivp1->environment->internal_vf_ivp31->envp_c_ivp3->j)] + u2[(clsr_v_ivp1->environment->internal_vf_ivp31->envp_c_ivp3->i)] * v2[(clsr_v_ivp1->environment->internal_vf_ivp31->envp_c_ivp3->j)];
    }
    clsr_v_ivp1->fptr = &clsr_ivp54;
    mWaitAll(clsr_v_ivp1);
}
void clsr_ivp53(struct Clsr *clsr_v_ivp1) {
    for ((clsr_v_ivp1->environment->internal_vf_ivp31->envp_c_ivp3->j) = 0; (clsr_v_ivp1->environment->internal_vf_ivp31->envp_c_ivp3->j) < 16384; (clsr_v_ivp1->environment->internal_vf_ivp31->envp_c_ivp3->j)++) {
        w[(clsr_v_ivp1->environment->internal_vf_ivp31->envp_c_ivp3->i)] = w[(clsr_v_ivp1->environment->internal_vf_ivp31->envp_c_ivp3->i)] + alpha * A[(clsr_v_ivp1->environment->internal_vf_ivp31->envp_c_ivp3->i)][(clsr_v_ivp1->environment->internal_vf_ivp31->envp_c_ivp3->j)] * x[(clsr_v_ivp1->environment->internal_vf_ivp31->envp_c_ivp3->j)];
    }
    clsr_v_ivp1->fptr = clsr_v_ivp1->environment->internal_vf_ivp31->continuation;
    clsr_v_ivp1->fptr(clsr_v_ivp1);
}
void clsr_ivp54(struct Clsr *clsr_v_ivp1) {
    for ((clsr_v_ivp1->environment->internal_vf_ivp31->envp_c_ivp3->j) = 0; (clsr_v_ivp1->environment->internal_vf_ivp31->envp_c_ivp3->j) < 16384; (clsr_v_ivp1->environment->internal_vf_ivp31->envp_c_ivp3->j)++) {
        x[(clsr_v_ivp1->environment->internal_vf_ivp31->envp_c_ivp3->i)] = x[(clsr_v_ivp1->environment->internal_vf_ivp31->envp_c_ivp3->i)] + beta * A[(clsr_v_ivp1->environment->internal_vf_ivp31->envp_c_ivp3->j)][(clsr_v_ivp1->environment->internal_vf_ivp31->envp_c_ivp3->i)] * y[(clsr_v_ivp1->environment->internal_vf_ivp31->envp_c_ivp3->j)];
    }
    x[(clsr_v_ivp1->environment->internal_vf_ivp31->envp_c_ivp3->i)] = x[(clsr_v_ivp1->environment->internal_vf_ivp31->envp_c_ivp3->i)] + z[(clsr_v_ivp1->environment->internal_vf_ivp31->envp_c_ivp3->i)];
    clsr_v_ivp1->fptr = &clsr_ivp53;
    mWaitAll(clsr_v_ivp1);
}
