...
void fun_ivp31(int verify);
void fun_ivp32(int verify);
struct master_env {
...
void while_ivp30_ivp69(struct ENV_PRIVATE_ivp9 *envp_c_ivp3, struct Clsr *clsr_v_ivp1);
struct internal_t_ivp40 {
    void ( *continuation )(struct Clsr *);
    struct ENV_PRIVATE_ivp9 *envp_c_ivp3;
} ;
void fun_ivp33_ivp71(struct ENV_PRIVATE_ivp9 *envp_c_ivp3, struct Clsr *clsr_v_ivp1);
void clsr_ivp80(struct Clsr *clsr_v_ivp1);
void clsr_ivp81(struct Clsr *clsr_v_ivp1);
...
#pragma omp parallel
    {
        ...
        void *env_p_ivp13;
        int tempSize_ivp14 = sizeof(struct ENV_PRIVATE_ivp9);
        env_p_ivp13 = malloc(tempSize_ivp14);
        env_p_ivp10 = (struct ENV_PRIVATE_ivp9 *) env_p_ivp13;
        int i;
        int pt;
        int p;
        int sval;
...
#pragma omp single nowait
        {
            startRange_ivp17 = 0;
            endRange_ivp17 = processes - 1;
            nThreads_ivp17 = omp_get_num_threads();
            nIters_ivp4 = endRange_ivp17 - startRange_ivp17 + 1;
            unsigned long int _imopVarPre19;
            void *_imopVarPre20;
            _imopVarPre19 = nThreads_ivp17 * sizeof(int);
            _imopVarPre20 = malloc(_imopVarPre19);
            leftPointer = (int *) _imopVarPre20;
            unsigned long int _imopVarPre23;
            void *_imopVarPre24;
            _imopVarPre23 = nThreads_ivp17 * sizeof(int);
            _imopVarPre24 = malloc(_imopVarPre23);
            rightPointer = (int *) _imopVarPre24;
            unsigned long int _imopVarPre27;
            void *_imopVarPre28;
            _imopVarPre27 = (nIters_ivp4 + startRange_ivp17) * sizeof(struct Clsr *);
            _imopVarPre28 = malloc(_imopVarPre27);
            readyWorkList = (struct Clsr **) _imopVarPre28;
        }
// #pragma omp dummyFlush BARRIER_START
#pragma omp barrier
        _imopVarPre68 = omp_get_thread_num();
        int tid_ivp17 = _imopVarPre68;
...
#pragma omp for private(i) nowait
        for (i = 0; i < processes; i++) {
            ...
            envp_c_ivp3->sval = (env_p_ivp10->sval);
            envp_c_ivp3->pt = (env_p_ivp10->pt);
            envp_c_ivp3->p = (env_p_ivp10->p);
            envp_c_ivp3->i = i;
            void ( *_imopVarPre44 )(struct Clsr *clsr_v_ivp1);
            struct Clsr *_imopVarPre45;
            _imopVarPre44 = &ompfor_ivp41;
            _imopVarPre45 = createClosure(NORMAL, _imopVarPre44, i);
            struct Clsr *clsr_v_ivp1 = _imopVarPre45;
            unsigned long int _imopVarPre48;
            void *_imopVarPre49;
            _imopVarPre48 = sizeof(struct master_env);
            _imopVarPre49 = malloc(_imopVarPre48);
            clsr_v_ivp1->environment = (struct master_env *) _imopVarPre49;
            unsigned long int _imopVarPre52;
            void *_imopVarPre53;
            _imopVarPre52 = sizeof(struct internal_tf_ivp35);
            _imopVarPre53 = malloc(_imopVarPre52);
            clsr_v_ivp1->environment->internal_vf_ivp36 = (struct internal_tf_ivp35 *) _imopVarPre53;
            clsr_v_ivp1->environment->internal_vf_ivp36->continuation = &lastFunction;
            int _imopVarPre55;
            _imopVarPre55 = omp_get_thread_num();
            if (i < leftPointer[_imopVarPre55]) {
                int _imopVarPre56;
                _imopVarPre56 = omp_get_thread_num();
                leftPointer[_imopVarPre56] = i;
            }
            int _imopVarPre58;
            _imopVarPre58 = omp_get_thread_num();
            if (i > rightPointer[_imopVarPre58]) {
                int _imopVarPre59;
                _imopVarPre59 = omp_get_thread_num();
                rightPointer[_imopVarPre59] = i;
            }
            readyWorkList[i] = clsr_v_ivp1;
            unsigned long int _imopVarPre62;
            void *_imopVarPre63;
            _imopVarPre62 = sizeof(struct internal_t_ivp38);
            _imopVarPre63 = malloc(_imopVarPre62);
            clsr_v_ivp1->environment->internal_v_ivp37 = (struct internal_t_ivp38 *) _imopVarPre63;
            unsigned long int _imopVarPre66;
            void *_imopVarPre67;
            _imopVarPre66 = sizeof(struct internal_t_ivp40);
            _imopVarPre67 = malloc(_imopVarPre66);
            clsr_v_ivp1->environment->internal_v_ivp39 = (struct internal_t_ivp40 *) _imopVarPre67;
...
void ompfor_ivp41(struct Clsr *clsr_v_ivp1) {
    ...
    while_ivp30_ivp69(envp_c_ivp3_ivp42, clsr_v_ivp1);
}
void while_ivp30_ivp69(struct ENV_PRIVATE_ivp9 *envp_c_ivp3, struct Clsr *clsr_v_ivp1) {
    clsr_v_ivp1->environment->internal_v_ivp37->envp_c_ivp3 = envp_c_ivp3;
    if (step < processes) {
        struct ENV_PRIVATE_ivp9 *envp_c_ivp3_ivp70;
        envp_c_ivp3_ivp70 = clsr_v_ivp1->environment->internal_v_ivp37->envp_c_ivp3;
        clsr_v_ivp1->environment->internal_v_ivp39->continuation = clsr_v_ivp1->environment->internal_v_ivp37->continuation;
        fun_ivp33_ivp71(envp_c_ivp3_ivp70, clsr_v_ivp1);
    } else {
        clsr_v_ivp1->fptr = clsr_v_ivp1->environment->internal_v_ivp37->continuation;
        void ( *_imopVarPre77 )(struct Clsr *);
        _imopVarPre77 = clsr_v_ivp1->fptr;
        _imopVarPre77(clsr_v_ivp1);
    }
}
void fun_ivp33_ivp71(struct ENV_PRIVATE_ivp9 *envp_c_ivp3, struct Clsr *clsr_v_ivp1) {
    clsr_v_ivp1->environment->internal_v_ivp39->envp_c_ivp3 = envp_c_ivp3;
    (clsr_v_ivp1->environment->internal_v_ivp39->envp_c_ivp3->pt) = (clsr_v_ivp1->environment->internal_v_ivp39->envp_c_ivp3->i);
    (clsr_v_ivp1->environment->internal_v_ivp39->envp_c_ivp3->pt) = ((clsr_v_ivp1->environment->internal_v_ivp39->envp_c_ivp3->pt) + 1) % processes;
    (clsr_v_ivp1->environment->internal_v_ivp39->envp_c_ivp3->p) = (clsr_v_ivp1->environment->internal_v_ivp39->envp_c_ivp3->pt);
    (clsr_v_ivp1->environment->internal_v_ivp39->envp_c_ivp3->sval) = processSet[(clsr_v_ivp1->environment->internal_v_ivp39->envp_c_ivp3->i)].send;
    processSet[(clsr_v_ivp1->environment->internal_v_ivp39->envp_c_ivp3->p)].receivedId = (clsr_v_ivp1->environment->internal_v_ivp39->envp_c_ivp3->sval);
    clsr_v_ivp1->fptr = &clsr_ivp81;
    mWaitAll(clsr_v_ivp1);
}
void clsr_ivp80(struct Clsr *clsr_v_ivp1) {
    struct ENV_PRIVATE_ivp9 *envp_c_ivp3_ivp74;
    envp_c_ivp3_ivp74 = clsr_v_ivp1->environment->internal_v_ivp39->envp_c_ivp3;
    clsr_v_ivp1->environment->internal_v_ivp37->continuation = clsr_v_ivp1->environment->internal_v_ivp39->continuation;
    while_ivp30_ivp69(envp_c_ivp3_ivp74, clsr_v_ivp1);
}
void clsr_ivp81(struct Clsr *clsr_v_ivp1) {
    if (processSet[(clsr_v_ivp1->environment->internal_v_ivp39->envp_c_ivp3->i)].receivedId > processSet[(clsr_v_ivp1->environment->internal_v_ivp39->envp_c_ivp3->i)].leaderId) {
        processSet[(clsr_v_ivp1->environment->internal_v_ivp39->envp_c_ivp3->i)].send = processSet[(clsr_v_ivp1->environment->internal_v_ivp39->envp_c_ivp3->i)].receivedId;
        processSet[(clsr_v_ivp1->environment->internal_v_ivp39->envp_c_ivp3->i)].leaderId = processSet[(clsr_v_ivp1->environment->internal_v_ivp39->envp_c_ivp3->i)].receivedId;
    } else {
        if (processSet[(clsr_v_ivp1->environment->internal_v_ivp39->envp_c_ivp3->i)].receivedId == processSet[(clsr_v_ivp1->environment->internal_v_ivp39->envp_c_ivp3->i)].id) {
            processSet[(clsr_v_ivp1->environment->internal_v_ivp39->envp_c_ivp3->i)].status = 1;
            processSet[(clsr_v_ivp1->environment->internal_v_ivp39->envp_c_ivp3->i)].leaderId = processSet[(clsr_v_ivp1->environment->internal_v_ivp39->envp_c_ivp3->i)].id;
        }
    }
    if ((clsr_v_ivp1->environment->internal_v_ivp39->envp_c_ivp3->i) == 1) {
        step++;
    }
    clsr_v_ivp1->fptr = &clsr_ivp80;
    mWaitAll(clsr_v_ivp1);
}
