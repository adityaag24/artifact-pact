...
void while_ivp62_ivp122(struct ENV_SHARED_ivp37 *env_s_ivp38, struct ENV_PRIVATE_ivp39 *envp_c_ivp14 , struct Clsr *clsr_v_ivp12);
...
void ompfor_ivp71(struct Clsr *clsr_v_ivp12) {
    ...
    while_ivp62_ivp122(env_s_ivp38_ivp72, envp_c_ivp14_ivp73, clsr_v_ivp12);
}
void while_ivp62_ivp122(struct ENV_SHARED_ivp37 *env_s_ivp38, struct ENV_PRIVATE_ivp39 *envp_c_ivp14 , struct Clsr *clsr_v_ivp12) {
...
void fun_ivp63_ivp125(struct ENV_SHARED_ivp37 *env_s_ivp38, struct ENV_PRIVATE_ivp39 *envp_c_ivp14 , struct Clsr *clsr_v_ivp12) {
    ...
    for ((clsr_v_ivp12->environment->internal_v_ivp69->env_s_ivp38->j) = 1; (clsr_v_ivp12->environment->internal_v_ivp69->env_s_ivp38->j) < 16384 - 1; (clsr_v_ivp12->environment->internal_v_ivp69->env_s_ivp38->j)++) {
        A[(clsr_v_ivp12->environment->internal_v_ivp69->envp_c_ivp14->i)][(clsr_v_ivp12->environment->internal_v_ivp69->env_s_ivp38->j)] = (B[(clsr_v_ivp12->environment->internal_v_ivp69->envp_c_ivp14->i) - 1][(clsr_v_ivp12->environment->internal_v_ivp69->env_s_ivp38->j)] + B[(clsr_v_ivp12->environment->internal_v_ivp69->envp_c_ivp14->i)][(clsr_v_ivp12->environment->internal_v_ivp69->env_s_ivp38->j) - 1] + B[(clsr_v_ivp12->environment->internal_v_ivp69->envp_c_ivp14->i)][(clsr_v_ivp12->environment->internal_v_ivp69->env_s_ivp38->j) + 1] + B[(clsr_v_ivp12->environment->internal_v_ivp69->envp_c_ivp14->i) + 1][(clsr_v_ivp12->environment->internal_v_ivp69->env_s_ivp38->j)]) / 4.0;
    }
...
void clsr_ivp141(struct Clsr *clsr_v_ivp12) {
    ...
    while_ivp62_ivp122(env_s_ivp38_ivp134, envp_c_ivp14_ivp135, clsr_v_ivp12);
}
void clsr_ivp142(struct Clsr *clsr_v_ivp12) {
