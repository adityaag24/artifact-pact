...
double **A;
struct Clsr *clsr_v_ivp12;
void waitWrapper_ivp17(int i, struct Clsr *clsr_v_ivp12);
void signalWrapper_ivp22(int i, struct Clsr *clsr_v_ivp12);
void waitWrapper_ivp27(int i, struct Clsr *clsr_v_ivp12);
void signalWrapper_ivp32(int i, struct Clsr *clsr_v_ivp12);
struct ENV_SHARED_ivp37 {
    int j;
} ;
struct ENV_PRIVATE_ivp39 {
    int i;
    int t;
} ;
struct master_env {
    struct internal_tf_ivp65 *internal_vf_ivp66;
    struct internal_t_ivp68 *internal_v_ivp67;
    struct internal_t_ivp70 *internal_v_ivp69;
} ;
struct internal_tf_ivp65 {
    void ( *continuation )(struct Clsr *);
    struct ENV_PRIVATE_ivp39 *envp_c_ivp14;
    struct ENV_SHARED_ivp37 *env_s_ivp38;
} ;
void ompfor_ivp71(struct Clsr *clsr_v_ivp12);
struct internal_t_ivp68 {
    void ( *continuation )(struct Clsr *);
    struct ENV_PRIVATE_ivp39 *envp_c_ivp14;
    struct ENV_SHARED_ivp37 *env_s_ivp38;
} ;
void while_ivp62_ivp122(struct ENV_PRIVATE_ivp39 *envp_c_ivp14, struct ENV_SHARED_ivp37 *env_s_ivp38 , struct Clsr *clsr_v_ivp12);
struct internal_t_ivp70 {
    void ( *continuation )(struct Clsr *);
    struct ENV_SHARED_ivp37 *env_s_ivp38;
    struct ENV_PRIVATE_ivp39 *envp_c_ivp14;
    int i_ivp47;
...
void fun_ivp63_ivp125(struct ENV_SHARED_ivp37 *env_s_ivp38, struct ENV_PRIVATE_ivp39 *envp_c_ivp14 , struct Clsr *clsr_v_ivp12);
void clsr_ivp141(struct Clsr *clsr_v_ivp12);
void clsr_ivp142(struct Clsr *clsr_v_ivp12);
void clsr_ivp143(struct Clsr *clsr_v_ivp12);
void clsr_ivp144(struct Clsr *clsr_v_ivp12);
int main(int argc, char **argv) {
    ...
    void *_imopVarPre204;
    _imopVarPre203 = sizeof(double *) * 16384;
    _imopVarPre204 = malloc(_imopVarPre203);
    A = (double **) _imopVarPre204;
    for (i = 0; i < 16384; i++) {
        unsigned long int _imopVarPre207;
        void *_imopVarPre208;
        _imopVarPre207 = sizeof(double) * 16384;
        _imopVarPre208 = malloc(_imopVarPre207);
        A[i] = (double *) _imopVarPre208;
    }
    for (j = 0; j < 16384; j++) {
        for (k = 0; k < 16384; k++) {
            double _imopVarPre209;
            _imopVarPre209 = drand48();
            A[j][k] = _imopVarPre209;
        }
    }
    double itime;
    double ftime;
    ...
    struct ENV_SHARED_ivp37 *env_s_ivp38;
    void *env_s_ivp43;
    int tempSize_ivp44 = sizeof(struct ENV_SHARED_ivp37);
    env_s_ivp43 = malloc(tempSize_ivp44);
    env_s_ivp38 = (struct ENV_SHARED_ivp37 *) env_s_ivp43;
    env_s_ivp38->j = j;
#pragma omp parallel private(i)
    {
        struct WLQueue *_imopVarPre60;
        _imopVarPre60 = createWorklistQueue();
        struct WLQueue *readyWorklist = _imopVarPre60;
#pragma omp single nowait
        {
            int _imopVarPre59;
            globalWorklist = createWorklistQueue();
            _imopVarPre59 = omp_get_num_threads();
            int nThreads_ivp16 = _imopVarPre59;
        }
// #pragma omp dummyFlush BARRIER_START
#pragma omp barrier
        struct ENV_PRIVATE_ivp39 *env_p_ivp40;
        void *env_p_ivp45;
        int tempSize_ivp46 = sizeof(struct ENV_PRIVATE_ivp39);
        env_p_ivp45 = malloc(tempSize_ivp46);
        env_p_ivp40 = (struct ENV_PRIVATE_ivp39 *) env_p_ivp45;
        int t = 0;
        env_p_ivp40->t = 0;
        i = (env_p_ivp40->i);
#pragma omp single nowait
        {
            startRange_ivp17 = 1;
            endRange_ivp17 = 16384 - 1 - 1;
            nIters_ivp15 = endRange_ivp17 - startRange_ivp17 + 1;
            unsigned long int _imopVarPre57;
            void *_imopVarPre58;
            _imopVarPre57 = (nIters_ivp15 + startRange_ivp17) * sizeof(struct HashTable *);
            _imopVarPre58 = malloc(_imopVarPre57);
            postbox_ivp17 = (struct HashTable **) _imopVarPre58;
        }
// #pragma omp dummyFlush BARRIER_START
#pragma omp barrier
#pragma omp for private(j) nowait
        for (i = 1; i < 16384 - 1; i++) {
            struct ENV_PRIVATE_ivp39 *envp_c_ivp14;
            void *envp_t_ivp41;
            int tempSize_ivp42 = sizeof(struct ENV_PRIVATE_ivp39);
            envp_t_ivp41 = malloc(tempSize_ivp42);
            envp_c_ivp14 = (struct ENV_PRIVATE_ivp39 *) envp_t_ivp41;
            envp_c_ivp14->t = (env_p_ivp40->t);
            envp_c_ivp14->i = (env_p_ivp40->i);
            envp_c_ivp14->i = i;
            struct Clsr *_imopVarPre87;
            void ( *_imopVarPre86 )(struct Clsr *clsr_v_ivp12);
            _imopVarPre86 = &ompfor_ivp71;
            _imopVarPre87 = createClosure(NORMAL, _imopVarPre86);
            struct Clsr *clsr_v_ivp12 = _imopVarPre87;
            unsigned long int _imopVarPre90;
            void *_imopVarPre91;
            _imopVarPre90 = sizeof(struct master_env);
            _imopVarPre91 = malloc(_imopVarPre90);
            clsr_v_ivp12->environment = (struct master_env *) _imopVarPre91;
            unsigned long int _imopVarPre98;
            void *_imopVarPre99;
            _imopVarPre98 = sizeof(struct internal_tf_ivp65);
            _imopVarPre99 = malloc(_imopVarPre98);
            clsr_v_ivp12->environment->internal_vf_ivp66 = (struct internal_tf_ivp65 *) _imopVarPre99;
            initialisePostBox(i);
            clsr_v_ivp12->environment->internal_vf_ivp66->continuation = &lastFunction;
// #pragma omp dummyFlush CRITICAL_START
#pragma omp critical
            {
                enqueueClosure(globalWorklist, clsr_v_ivp12);
            }
// #pragma omp dummyFlush CRITICAL_END
            unsigned long int _imopVarPre106;
            void *_imopVarPre107;
            _imopVarPre106 = sizeof(struct internal_t_ivp70);
            _imopVarPre107 = malloc(_imopVarPre106);
            clsr_v_ivp12->environment->internal_v_ivp69 = (struct internal_t_ivp70 *) _imopVarPre107;
            unsigned long int _imopVarPre114;
            void *_imopVarPre115;
            _imopVarPre114 = sizeof(struct internal_t_ivp68);
            _imopVarPre115 = malloc(_imopVarPre114);
            clsr_v_ivp12->environment->internal_v_ivp67 = (struct internal_t_ivp68 *) _imopVarPre115;
            clsr_v_ivp12->environment->internal_vf_ivp66->envp_c_ivp14 = envp_c_ivp14;
            clsr_v_ivp12->environment->internal_vf_ivp66->env_s_ivp38 = env_s_ivp38;
        }
// #pragma omp dummyFlush BARRIER_START
#pragma omp barrier
#pragma omp single nowait
        {
            int nThreads_ivp120;
            nThreads_ivp120 = omp_get_num_threads();
            int cond_ivp121;
            cond_ivp121 = nIters_ivp15 > nThreads_ivp120;
            if (cond_ivp121) {
                K = nIters_ivp15 / nThreads_ivp120;
            } else {
                K = 1;
            }
        }
...
void waitWrapper_ivp17(int i, struct Clsr *clsr_v_ivp12) {
    ...
    if (1) {
        ...
        unsigned long int _imopVarPre224;
        void *_imopVarPre225;
        _imopVarPre224 = n_iters * sizeof(int);
        _imopVarPre225 = malloc(_imopVarPre224);
        int *q = (int *) _imopVarPre225;
        int i_ivp = 0;
        for (i_ivp = 0; i_ivp < n_iters; i_ivp++) {
            q[i_ivp] = p[i_ivp];
        }
        createWaitClosure(i, (void *) 0, (void *) 0, (void *) 0, (void *) 0, (void *) 0, 0, n_iters, q, &clsr_v_ivp12, 1);
    } else {
        void ( *_imopVarPre19 )(struct Clsr *);
        _imopVarPre19 = clsr_v_ivp12->fptr;
        _imopVarPre19(clsr_v_ivp12);
    }
}
void signalWrapper_ivp22(int i, struct Clsr *clsr_v_ivp12) {
    int wxyz = 0;
    if (1) {
        int p[] = {i - 1, i + 1};
        int n_iters = sizeof (p) / sizeof (p[0]);
        unsigned long int _imopVarPre220;
        void *_imopVarPre221;
        _imopVarPre220 = n_iters * sizeof(int);
        _imopVarPre221 = malloc(_imopVarPre220);
        int *q_ivp = (int *) _imopVarPre221;
        int i_ivp = 0;
        for (i_ivp = 0; i_ivp < n_iters; i_ivp++) {
            q_ivp[i_ivp] = p[i_ivp];
        }
        mSignal(1, i, 0, n_iters, q_ivp, clsr_v_ivp12);
    } else {
        void ( *_imopVarPre24 )(struct Clsr *);
        _imopVarPre24 = clsr_v_ivp12->fptr;
        _imopVarPre24(clsr_v_ivp12);
    }
}
void waitWrapper_ivp27(int i, struct Clsr *clsr_v_ivp12) {
    int wxyz = 0;
    if (1) {
        ...
        void *_imopVarPre217;
        _imopVarPre216 = n_iters * sizeof(int);
        _imopVarPre217 = malloc(_imopVarPre216);
        int *q = (int *) _imopVarPre217;
        int i_ivp = 0;
        for (i_ivp = 0; i_ivp < n_iters; i_ivp++) {
            q[i_ivp] = p[i_ivp];
        }
        ...
        void ( *_imopVarPre29 )(struct Clsr *);
        _imopVarPre29 = clsr_v_ivp12->fptr;
        _imopVarPre29(clsr_v_ivp12);
    }
}
void signalWrapper_ivp32(int i, struct Clsr *clsr_v_ivp12) {
    int wxyz = 0;
    if (1) {
        ...
        void *_imopVarPre213;
        _imopVarPre212 = n_iters * sizeof(int);
        _imopVarPre213 = malloc(_imopVarPre212);
        int *q_ivp = (int *) _imopVarPre213;
        int i_ivp = 0;
        for (i_ivp = 0; i_ivp < n_iters; i_ivp++) {
            q_ivp[i_ivp] = p[i_ivp];
        }
        ...
        void ( *_imopVarPre34 )(struct Clsr *);
        _imopVarPre34 = clsr_v_ivp12->fptr;
        _imopVarPre34(clsr_v_ivp12);
    }
}
void ompfor_ivp71(struct Clsr *clsr_v_ivp12) {
    struct ENV_SHARED_ivp37 *env_s_ivp38_ivp72;
    struct ENV_PRIVATE_ivp39 *envp_c_ivp14_ivp73;
    env_s_ivp38_ivp72 = clsr_v_ivp12->environment->internal_vf_ivp66->env_s_ivp38;
    envp_c_ivp14_ivp73 = clsr_v_ivp12->environment->internal_vf_ivp66->envp_c_ivp14;
    clsr_v_ivp12->environment->internal_v_ivp67->continuation = clsr_v_ivp12->environment->internal_vf_ivp66->continuation;
    while_ivp62_ivp122(envp_c_ivp14_ivp73, env_s_ivp38_ivp72, clsr_v_ivp12);
}
void while_ivp62_ivp122(struct ENV_PRIVATE_ivp39 *envp_c_ivp14, struct ENV_SHARED_ivp37 *env_s_ivp38 , struct Clsr *clsr_v_ivp12) {
    clsr_v_ivp12->environment->internal_v_ivp67->envp_c_ivp14 = envp_c_ivp14;
    clsr_v_ivp12->environment->internal_v_ivp67->env_s_ivp38 = env_s_ivp38;
    if ((clsr_v_ivp12->environment->internal_v_ivp67->envp_c_ivp14->t) < 50) {
        struct ENV_SHARED_ivp37 *env_s_ivp38_ivp123;
        struct ENV_PRIVATE_ivp39 *envp_c_ivp14_ivp124;
        env_s_ivp38_ivp123 = clsr_v_ivp12->environment->internal_v_ivp67->env_s_ivp38;
        envp_c_ivp14_ivp124 = clsr_v_ivp12->environment->internal_v_ivp67->envp_c_ivp14;
        clsr_v_ivp12->environment->internal_v_ivp69->continuation = clsr_v_ivp12->environment->internal_v_ivp67->continuation;
        fun_ivp63_ivp125(env_s_ivp38_ivp123, envp_c_ivp14_ivp124, clsr_v_ivp12);
    } else {
        clsr_v_ivp12->fptr = clsr_v_ivp12->environment->internal_v_ivp67->continuation;
        void ( *_imopVarPre138 )(struct Clsr *);
        _imopVarPre138 = clsr_v_ivp12->fptr;
        _imopVarPre138(clsr_v_ivp12);
    }
}
void fun_ivp63_ivp125(struct ENV_SHARED_ivp37 *env_s_ivp38, struct ENV_PRIVATE_ivp39 *envp_c_ivp14 , struct Clsr *clsr_v_ivp12) {
    clsr_v_ivp12->environment->internal_v_ivp69->env_s_ivp38 = env_s_ivp38;
    clsr_v_ivp12->environment->internal_v_ivp69->envp_c_ivp14 = envp_c_ivp14;
    for ((clsr_v_ivp12->environment->internal_v_ivp69->env_s_ivp38->j) = 1; (clsr_v_ivp12->environment->internal_v_ivp69->env_s_ivp38->j) < 16384 - 1; (clsr_v_ivp12->environment->internal_v_ivp69->env_s_ivp38->j)++) {
        if (((clsr_v_ivp12->environment->internal_v_ivp69->envp_c_ivp14->i) + (clsr_v_ivp12->environment->internal_v_ivp69->env_s_ivp38->j)) % 2 == 0) {
            A[(clsr_v_ivp12->environment->internal_v_ivp69->envp_c_ivp14->i)][(clsr_v_ivp12->environment->internal_v_ivp69->env_s_ivp38->j)] = 0.25 * (A[(clsr_v_ivp12->environment->internal_v_ivp69->envp_c_ivp14->i) - 1][(clsr_v_ivp12->environment->internal_v_ivp69->env_s_ivp38->j)] + A[(clsr_v_ivp12->environment->internal_v_ivp69->envp_c_ivp14->i) + 1][(clsr_v_ivp12->environment->internal_v_ivp69->env_s_ivp38->j)] + A[(clsr_v_ivp12->environment->internal_v_ivp69->envp_c_ivp14->i)][(clsr_v_ivp12->environment->internal_v_ivp69->env_s_ivp38->j) - 1] + A[(clsr_v_ivp12->environment->internal_v_ivp69->envp_c_ivp14->i)][(clsr_v_ivp12->environment->internal_v_ivp69->env_s_ivp38->j) + 1]);
        }
    }
    clsr_v_ivp12->environment->internal_v_ivp69->i_ivp47 = (clsr_v_ivp12->environment->internal_v_ivp69->envp_c_ivp14->i);
    int i_ivp47_ivp126;
    i_ivp47_ivp126 = clsr_v_ivp12->environment->internal_v_ivp69->i_ivp47;
    clsr_v_ivp12->fptr = &clsr_ivp144;
    signalWrapper_ivp32(i_ivp47_ivp126, clsr_v_ivp12);
}
void clsr_ivp141(struct Clsr *clsr_v_ivp12) {
    (clsr_v_ivp12->environment->internal_v_ivp69->envp_c_ivp14->t)++;
    struct ENV_SHARED_ivp37 *env_s_ivp38_ivp134;
    struct ENV_PRIVATE_ivp39 *envp_c_ivp14_ivp135;
    env_s_ivp38_ivp134 = clsr_v_ivp12->environment->internal_v_ivp69->env_s_ivp38;
    envp_c_ivp14_ivp135 = clsr_v_ivp12->environment->internal_v_ivp69->envp_c_ivp14;
    clsr_v_ivp12->environment->internal_v_ivp67->continuation = clsr_v_ivp12->environment->internal_v_ivp69->continuation;
    while_ivp62_ivp122(envp_c_ivp14_ivp135, env_s_ivp38_ivp134, clsr_v_ivp12);
}
void clsr_ivp142(struct Clsr *clsr_v_ivp12) {
    clsr_v_ivp12->environment->internal_v_ivp69->i_ivp53 = (clsr_v_ivp12->environment->internal_v_ivp69->envp_c_ivp14->i);
    int i_ivp53_ivp132;
    i_ivp53_ivp132 = clsr_v_ivp12->environment->internal_v_ivp69->i_ivp53;
    clsr_v_ivp12->fptr = &clsr_ivp141;
    waitWrapper_ivp17(i_ivp53_ivp132, clsr_v_ivp12);
}
void clsr_ivp143(struct Clsr *clsr_v_ivp12) {
    for ((clsr_v_ivp12->environment->internal_v_ivp69->env_s_ivp38->j) = 1; (clsr_v_ivp12->environment->internal_v_ivp69->env_s_ivp38->j) < 16384 - 1; (clsr_v_ivp12->environment->internal_v_ivp69->env_s_ivp38->j)++) {
        if (((clsr_v_ivp12->environment->internal_v_ivp69->envp_c_ivp14->i) + (clsr_v_ivp12->environment->internal_v_ivp69->env_s_ivp38->j)) % 2 == 1) {
            A[(clsr_v_ivp12->environment->internal_v_ivp69->envp_c_ivp14->i)][(clsr_v_ivp12->environment->internal_v_ivp69->env_s_ivp38->j)] = 0.25 * (A[(clsr_v_ivp12->environment->internal_v_ivp69->envp_c_ivp14->i) - 1][(clsr_v_ivp12->environment->internal_v_ivp69->env_s_ivp38->j)] + A[(clsr_v_ivp12->environment->internal_v_ivp69->envp_c_ivp14->i) + 1][(clsr_v_ivp12->environment->internal_v_ivp69->env_s_ivp38->j)] + A[(clsr_v_ivp12->environment->internal_v_ivp69->envp_c_ivp14->i)][(clsr_v_ivp12->environment->internal_v_ivp69->env_s_ivp38->j) - 1] + A[(clsr_v_ivp12->environment->internal_v_ivp69->envp_c_ivp14->i)][(clsr_v_ivp12->environment->internal_v_ivp69->env_s_ivp38->j) + 1]);
        }
    }
    clsr_v_ivp12->environment->internal_v_ivp69->i_ivp51 = (clsr_v_ivp12->environment->internal_v_ivp69->envp_c_ivp14->i);
    int i_ivp51_ivp130;
    i_ivp51_ivp130 = clsr_v_ivp12->environment->internal_v_ivp69->i_ivp51;
    clsr_v_ivp12->fptr = &clsr_ivp142;
    signalWrapper_ivp22(i_ivp51_ivp130, clsr_v_ivp12);
}
void clsr_ivp144(struct Clsr *clsr_v_ivp12) {
    clsr_v_ivp12->environment->internal_v_ivp69->i_ivp49 = (clsr_v_ivp12->environment->internal_v_ivp69->envp_c_ivp14->i);
    int i_ivp49_ivp128;
    i_ivp49_ivp128 = clsr_v_ivp12->environment->internal_v_ivp69->i_ivp49;
    clsr_v_ivp12->fptr = &clsr_ivp143;
    waitWrapper_ivp27(i_ivp49_ivp128, clsr_v_ivp12);
}
