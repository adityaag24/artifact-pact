...
void init() {
    ...
    for (i = 0; i < 16384; i++) {
        ...
        _imopVarPre203 = calloc(16384, _imopVarPre202);
        A[i] = _imopVarPre203;
        unsigned long int _imopVarPre205;
        void *_imopVarPre206;
        _imopVarPre205 = sizeof(double);
        _imopVarPre206 = calloc(16384, _imopVarPre205);
        B[i] = _imopVarPre206;
        for (j = 0; j < 16384; j++) {
            A[i][j] = (((double) i) * (j + 2) + 2) / 16384;
            B[i][j] = (((double) i) * (j + 3) + 3) / 16384;
        }
    }
}
struct Clsr *clsr_v_ivp12;
void signalWrapper_ivp17(int i, struct Clsr *clsr_v_ivp12);
void waitWrapper_ivp22(int i, struct Clsr *clsr_v_ivp12);
void signalWrapper_ivp27(int i, struct Clsr *clsr_v_ivp12);
void waitWrapper_ivp32(int i, struct Clsr *clsr_v_ivp12);
...
int main(int argc, char **argv) {
    ...
    _imopVarPre209 = calloc(16384, _imopVarPre208);
    A = _imopVarPre209;
    unsigned long int _imopVarPre211;
    void *_imopVarPre212;
    _imopVarPre211 = sizeof(double);
    _imopVarPre212 = calloc(16384, _imopVarPre211);
    B = _imopVarPre212;
    init();
    int i;
    int j;
...
void fun_ivp63_ivp125(struct ENV_SHARED_ivp37 *env_s_ivp38, struct ENV_PRIVATE_ivp39 *envp_c_ivp14 , struct Clsr *clsr_v_ivp12) {
    ...
    for ((clsr_v_ivp12->environment->internal_v_ivp69->env_s_ivp38->j) = 1; (clsr_v_ivp12->environment->internal_v_ivp69->env_s_ivp38->j) < 16384 - 1; (clsr_v_ivp12->environment->internal_v_ivp69->env_s_ivp38->j)++) {
        B[(clsr_v_ivp12->environment->internal_v_ivp69->envp_c_ivp14->i)][(clsr_v_ivp12->environment->internal_v_ivp69->env_s_ivp38->j)] = 0.2 * (A[(clsr_v_ivp12->environment->internal_v_ivp69->envp_c_ivp14->i)][(clsr_v_ivp12->environment->internal_v_ivp69->env_s_ivp38->j)] + A[(clsr_v_ivp12->environment->internal_v_ivp69->envp_c_ivp14->i)][(clsr_v_ivp12->environment->internal_v_ivp69->env_s_ivp38->j) - 1] + A[(clsr_v_ivp12->environment->internal_v_ivp69->envp_c_ivp14->i)][(clsr_v_ivp12->environment->internal_v_ivp69->env_s_ivp38->j) + 1] + A[(clsr_v_ivp12->environment->internal_v_ivp69->envp_c_ivp14->i) + 1][(clsr_v_ivp12->environment->internal_v_ivp69->env_s_ivp38->j)] + A[(clsr_v_ivp12->environment->internal_v_ivp69->envp_c_ivp14->i) - 1][(clsr_v_ivp12->environment->internal_v_ivp69->env_s_ivp38->j)]);
    }
    ...
    signalWrapper_ivp27(i_ivp47_ivp126, clsr_v_ivp12);
}
void clsr_ivp141(struct Clsr *clsr_v_ivp12) {
...
void clsr_ivp142(struct Clsr *clsr_v_ivp12) {
    ...
    waitWrapper_ivp32(i_ivp53_ivp132, clsr_v_ivp12);
}
void clsr_ivp143(struct Clsr *clsr_v_ivp12) {
    for ((clsr_v_ivp12->environment->internal_v_ivp69->env_s_ivp38->j) = 1; (clsr_v_ivp12->environment->internal_v_ivp69->env_s_ivp38->j) < 16384 - 1; (clsr_v_ivp12->environment->internal_v_ivp69->env_s_ivp38->j)++) {
        A[(clsr_v_ivp12->environment->internal_v_ivp69->envp_c_ivp14->i)][(clsr_v_ivp12->environment->internal_v_ivp69->env_s_ivp38->j)] = B[(clsr_v_ivp12->environment->internal_v_ivp69->envp_c_ivp14->i)][(clsr_v_ivp12->environment->internal_v_ivp69->env_s_ivp38->j)];
    }
    ...
    signalWrapper_ivp17(i_ivp51_ivp130, clsr_v_ivp12);
}
void clsr_ivp144(struct Clsr *clsr_v_ivp12) {
    ...
    waitWrapper_ivp22(i_ivp49_ivp128, clsr_v_ivp12);
}
