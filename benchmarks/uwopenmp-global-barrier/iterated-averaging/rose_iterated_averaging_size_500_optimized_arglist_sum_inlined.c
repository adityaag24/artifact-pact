...
void parallel_for_body1__while__0_cps(void **arg_list,struct __cont_env *contn_env,int phase_num, struct __cont_env *old_env)
{
  ...
  uwomp_barrier(parallel_for_body1__while__0_cps_cont_env3,phase_num);
    ...
    // TODO: Arglist optimization
    // TODO: After inline sum_cps it this array is not required.
//void **arg_list_3[500];
//TODO: Add the fourth argument.
void parallel_for_body1__while__0_cps_cont3(void **arg_list,struct __cont_env *contn_env,int phase_num, struct __cont_env *old_env)
{
  ...
  if (__if_v0) {
		//TODO: Reuse the memory allocated for previous environment
        //TODO: sum_cps is inlined here. So it is not  required to create
        //parallel_for_body1__while__0_cps_cont_env4 which was earlier set as
        //continuation to sum_cps.
    ...
    // TODO: Arglist optimization Ends
    ...
    //    uwomp_call_contn_fun(contn_env);
    //}
    //The following funcitonc can be called directly. Further optmizations can be done to 
    //inline this too.
    parallel_for_body1__while__0_cps_cont4(arg_list, contn_env, phase_num, old_env);
    //TODO: sum_cps is inlined here ENDS
