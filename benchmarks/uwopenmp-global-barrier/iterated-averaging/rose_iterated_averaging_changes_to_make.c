...
#pragma omp single 
{
      uwomp_worklist_init((omp_get_num_threads()),0);
		...
		//fprintf(stderr, "delta = %f epsilon = %f iters = %d\n", delta, epsilon, iters);
    void **__parreg_arglist;
    __parreg_arglist = ((void **)(malloc(1 * sizeof(void *))));
    __parreg_arglist[0] = &iters;

		// TODO: Add the following
		struct __cont_env *init_contn_env = calloc(1, sizeof(struct __cont_env ));
...
void parallel_for_body1_cps(void **arg_list,struct __cont_env *contn_env,int phase_num)
{
	//fprintf(stderr, "Inside parallel_for_body1_cps\n");
  int i = (int )arg_list[0];
  int *iters = (int *)arg_list[1];

	free(arg_list);

  struct __cont_env *parallel_for_body1_cps_cont_env1 = calloc(1, sizeof(struct __cont_env ));
	parallel_for_body1_cps_cont_env1 -> arg_list = NULL;
...
void parallel_for_body1_cps_cont1(void **arg_list,struct __cont_env *contn_env,int phase_num)
{
	//fprintf(stderr, "Inside parallel_for_body1_cps_cont1\n");
  if (contn_env != NULL) {
...
void ompRegBody_cps(void **arg_list,struct __cont_env *contn_env,int phase_num)
{
	//fprintf(stderr, "Inside ompRegBody_cps\n");
...
#pragma omp for  private(i)
  for (i = 1; i <= 100; i++) {
    struct __cont_env *ompRegBody_cps_cont_env2 = calloc(1, sizeof(struct __cont_env ));
    ...
    arg_list_2[0] = i;
    arg_list_2[1] = iters;
    struct __cont_env *ompRegBody_cps_cps_cont_env_1_1 = calloc(1, sizeof(struct __cont_env ));
...
void ompRegBody_cps_cont2(void **arg_list,struct __cont_env *contn_env,int phase_num)
{
	//fprintf(stderr, "Inside ompRegBody_cps_cont2\n");
  if (contn_env != NULL) {
		uwomp_call_contn_fun(contn_env);
  }
}
...
void parallel_for_body1__while__0_cps(void **arg_list,struct __cont_env *contn_env,int phase_num)
{
	//fprintf(stderr, "Inside parallel_for_body1__while__0_cps start\n");
	//fprintf(stderr, "p_i = %u p_iters = %u\n", *((int *)arg_list[0]), *((int **)arg_list[1]));
  ...
  int i =  *p_i;
	...
	//fprintf(stderr, "i = %d delta = %f epsilon = %f iters = %d\n", i, delta, epsilon, *iters);
  ...
  struct __cont_env *parallel_for_body1__while__0_cps_cont_env3 = calloc(1, sizeof(struct __cont_env ));
  ...
  (parallel_for_body1__while__0_cps_cont_env3 -> cont_fn) = parallel_for_body1__while__0_cps_cont3;
	//fprintf(stderr, "7\n");
	//fprintf(stderr, "i = %d Before first barrier\n", i);
  uwomp_barrier(parallel_for_body1__while__0_cps_cont_env3,phase_num);
}

void parallel_for_body1__while__0_cps_cont3(void **arg_list,struct __cont_env *contn_env,int phase_num)
{
	//fprintf(stderr, "Inside parallel_for_body1__while__0_cps_cont3\n");
  ...
  int **p_iters = (int **)arg_list[4];
	...
	//fprintf(stderr, "i = %d Inside parallel_for_body1__while__0_cps_cont3\n", i);
	free(arg_list);

  __if_v0 = i == 1;
  if (__if_v0) {
		//fprintf(stderr, "i = %d Inside parallel_for_body1__while__0_cps_cont3 inside if start\n", i);
    struct __cont_env *parallel_for_body1__while__0_cps_cont_env4 = calloc(1, sizeof(struct __cont_env ));
    ...
    sum_cps(arg_list_3,parallel_for_body1__while__0_cps_cont_env4,phase_num);
		//fprintf(stderr, "i = %d Inside parallel_for_body1__while__0_cps_cont3 inside if end\n", i);
  }
   else {
    struct __cont_env *parallel_for_body1__while__0_cps_cont_env4 = calloc(1, sizeof(struct __cont_env ));
    parallel_for_body1__while__0_cps_cont_env4 -> arg_list = ((void **)(malloc(5 * sizeof(void *))));
    ...
    parallel_for_body1__while__0_cps_cont_env4 -> contn_env = contn_env;
    parallel_for_body1__while__0_cps_cont_env4 -> cont_fn = parallel_for_body1__while__0_cps_cont4;
		//fprintf(stderr, "i = %d Inside parallel_for_body1__while__0_cps_cont3 inside else start\n", i);
    ...
    //(parallel_for_body1__while__0_cps_cont_env4 -> cont_fn)(parallel_for_body1__while__0_cps_cont_env4 -> arg_list,parallel_for_body1__while__0_cps_cont_env4 -> contn_env,parallel_for_body1__while__0_cps_cont_env4 -> phase_num);
		//fprintf(stderr, "i = %d Inside parallel_for_body1__while__0_cps_cont3 inside else end\n", i);
  }
}
...
void parallel_for_body1__while__0_cps_cont4(void **arg_list,struct __cont_env *contn_env,int phase_num)
{
  ...
  int *p_i = (int *)arg_list[3];
  int **p_iters = (int **)arg_list[4];
	//fprintf(stderr, "i = %d Inside parallel_for_body1__while__0_cps_cont4\n", i);
  ...
  if (__if_v0) {
    ...
    newA = oldA;
    oldA = temp;
		//fprintf(stderr, "i = %d Inside parallel_for_body1__while__0_cps_cont4 before barrier\n", i);
  } 
	struct __cont_env *parallel_for_body1__while__0_cps_cont_env5 = calloc(1, sizeof(struct __cont_env ));
  ...
  (parallel_for_body1__while__0_cps_cont_env5 -> cont_fn) = parallel_for_body1__while__0_cps_cont5;
	...
	//if (!__if_v0) {
		//fprintf(stderr, "i = %d Inside parallel_for_body1__while__0_cps_cont4 after barrier\n", i);
	//}
}
...
void parallel_for_body1__while__0_cps_cont5(void **arg_list,struct __cont_env *contn_env,int phase_num)
{
  ...
  int **p_iters = (int **)arg_list[3];
	//fprintf(stderr, "i = %d Inside parallel_for_body1__while__0_cps_cont5 start\n", i);

	free(arg_list);

   *p_i = i;
   *p_iters = iters;
  struct __cont_env *parallel_for_body1__while__0_cps_cont_env6 = calloc(1, sizeof(struct __cont_env ));
  ...
  arg_list_4[1] = p_iters;
	//fprintf(stderr, "i = %d Inside parallel_for_body1__while__0_cps_cont5 end\n", i);
  parallel_for_body1__while__0_cps(arg_list_4,parallel_for_body1__while__0_cps_cont_env6,phase_num);
}

void parallel_for_body1__while__0_cps_cont6(void **arg_list,struct __cont_env *contn_env,int phase_num)
{
	//fprintf(stderr, "Inside parallel_for_body1__while__0_cps_cont6\n");
	if (contn_env != NULL) {
		uwomp_call_contn_fun(contn_env);
	}
}
