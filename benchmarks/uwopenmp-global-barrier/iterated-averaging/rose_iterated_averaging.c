...
void parallel_for_body1(int i,int *iters,int *j);
void OmpRegBody1(int *iters,int *j);
double *newA;
double *oldA;
double *diff;
double *temp;
...
#pragma omp single 
{
    arg_list_parallel_for_body1_0 = calloc(128 / 2 - -1,sizeof(void **));
    arg_list_OmpRegBody1_0 = calloc(128 / 2 - -1,sizeof(void **));
    arg_list_sum_0 = calloc(128 / 2 - -1,sizeof(void **));
    arg_list_parallel_for_body1__while__0_0 = calloc(128 / 2 - -1,sizeof(void **));
  }
