...
NTHREADS=32
TSTEPS=$4
#echo "SIZE   VAL NTHREADS AvgRuntime    ITERATIONS" >> jacobi-2d_trans.results
...
#echo "Average Running Time for jacobi-2d_trans = " $avg
echo $avg
#echo "$size   FLT_MAX/2 $thread $avg   $iters" >> jacobi-2d_trans.results
