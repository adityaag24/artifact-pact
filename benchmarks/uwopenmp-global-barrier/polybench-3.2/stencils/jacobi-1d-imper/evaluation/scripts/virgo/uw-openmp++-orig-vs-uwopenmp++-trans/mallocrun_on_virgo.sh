...
rm trans; gcc -std=c99 -O3 -fopenmp -I $SRCDIR/../../utilities -I $SRCDIR/../../stencils/jacobi-1d-imper $SRCDIR/../../utilities/polybench.c -DPOLYBENCH_TIME $SRCDIR/rose_jacobi-1d-imper_final.c -o trans 
