...
void parallel_for_body1__while__0(int i,int *t,int *tsteps);
...
//POLYBENCH_1D_ARRAY_DECL(B, DATA_TYPE, N, n);
  A = (calloc(262144,sizeof(double )));
  B = (calloc(262144,sizeof(double )));
/* Initialize array(s). */
...
#pragma omp for  private(i)
  for (i = 1; i <  *n - 1; i++) {
    ...
    OmpRegBody1_cps_cps_cont_env_1_1 -> cont_fn = parallel_for_body1__while__0_cps;
