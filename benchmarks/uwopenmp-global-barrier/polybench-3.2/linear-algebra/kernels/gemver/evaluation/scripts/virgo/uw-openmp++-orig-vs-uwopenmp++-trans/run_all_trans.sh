...
size=$3
NTHREADS=32
#echo "SIZE   VAL NTHREADS AvgRuntime    ITERATIONS" >> gemver_trans.results
...
#echo "Average Running Time for gemver_trans = " $avg
echo $avg
#echo "$size   FLT_MAX/2 $thread $avg   $iters" >> gemver_trans.results
