...
rm trans; gcc -O3 -fopenmp $SRCDIR/rose_sor_final.c -o trans

rundir="/home/induk/raghesh/uw-openmp/benchmarks/uwopenmp-global-barrier/sor/evaluation/scripts/k2/uw-openmp++-orig-vs-uwopenmp++-trans"
...
echo $avg
#rm sor_trans.out sor_trans.err
