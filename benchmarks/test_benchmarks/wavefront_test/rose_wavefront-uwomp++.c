...
#pragma omp single 
{
      uwomp_worklist_init((omp_get_num_threads()),32556);
    }
...
#pragma omp single 
{
    arg_list_parallel_for_body1_0 = calloc(1024 - 1,sizeof(void **));
    arg_list_OmpRegBody1_0 = calloc(1024 - 1,sizeof(void **));
    arg_list_recTask_0 = calloc(1024 - 1,sizeof(void **));
  }
